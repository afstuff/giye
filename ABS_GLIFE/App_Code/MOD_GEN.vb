...
Public Module MOD_GEN
    ...
    Public gnComp_FaxNum As String
    Public gnComp_Email1 As String

    Public gnSI_Amt As Double = 0
    Public gnSI_Rate As Single = 0
    Public gnPrem_Amt As Double = 0
    Public gnPrem_Rate As Single = 0
    ...
    Public Function gnCheck_DateStaus(ByVal pvCODE As String, ByVal pvProcDte As String) As Boolean
        ...
        Select Case RTrim(pvCODE)
            Case "001"  'U/W
            Case "002"  'Claims Reported
            Case "003"  'Claims Paid

            Case "101"  'Accounts
            Case "201"  'Payroll/HR
            Case "301"  'Fixed Asset
            Case "401"  'Investment
            Case Else
        End Select

        gnSQL = ""
        gnSQL = gnSQL & "select flock_status from ABSFILESTATUS"
        gnSQL = gnSQL & " where flock_id = '" & RTrim(pvCODE) & "'"
        gnSQL = gnSQL & " and flock_date = '" & RTrim(pvProcDte) & "'"
        ...
        If (objOLEDR.Read()) Then
            Select Case CType(objOLEDR("flock_status") & vbNullString, String)
                Case "Y"
                    pvbln = True
            End Select
    ...
    Public Function gnGET_COMPANY_INFO(ByVal pvREC_ID As String, ByVal pvREC_NUM As String, ByVal pvCONN_STRING As String) As String
        ...
        Try
            ...
            If (objOLEDR.Read()) Then
                ...
                gnComp_Addr3 = RTrim(objOLEDR("comp_addr3") & vbNullString).ToString

                gnComp_RegNum = RTrim(objOLEDR("COMP_REG_NUM") & vbNullString).ToString

                gnComp_TelNum = RTrim(objOLEDR("COMP_TEL_NUM1") & vbNullString).ToString
                gnComp_TelNum2 = RTrim(objOLEDR("COMP_TEL_NUM2") & vbNullString).ToString
                gnComp_TelNum3 = RTrim(objOLEDR("COMP_TEL_NUM3") & vbNullString).ToString

                gnComp_FaxNum = RTrim(objOLEDR("COMP_FAX_NUM1") & vbNullString).ToString

                gnComp_Email1 = RTrim(objOLEDR("COMP_EMAIL_NUM1") & vbNullString).ToString
    ...
    Public Function gnGET_CONN_STRING(Optional ByVal pvApp_Type As String = "ABS_ALL") As String
        ...
        mystrCONN_STRING = "Data Source=ABS-PC;Initial Catalog=ABS_LIFE;User ID=SA;Password=;"
        mystrCONN_STRING = CType(ConfigurationManager.ConnectionStrings("ABSGL_CONN").ToString, String)
    ...
    Public Function gnGET_RATE(ByVal pvstr_GET_WHAT As String, ByVal pvstr_MODULE As String, ByVal pvstr_RATE_CODE As String, ByVal pvstr_PRODUCT_REF_CODE As String, ByVal pvstr_PERIOD As String, ByVal pvstr_AGE As String, Optional ByVal pvCtr_Label As Label = Nothing, Optional ByVal pvRef_Misc As TextBox = Nothing, Optional ByVal pvRef_Misc_02 As TextBox = Nothing) As String
        ...
        Select Case Trim(pvstr_GET_WHAT)
            ...
            Case "GET_IL_EXCHANGE_RATE", "GET_GL_EXCHANGE_RATE"
            ...
            Case "GET_IL_MOP_FACTOR", "GET_GL_MOP_FACTOR"
        ...
        Try
            ...
            If (myole_DR.Read()) Then
                ...
                Select Case Trim(pvstr_GET_WHAT)
                    Case "GET_IL_PREMIUM_RATE", "GET_GL_PREMIUM_RATE"
                ...
                Select Case Trim(pvstr_GET_WHAT)
                    Case "GET_POLICY_BY_FILE_NO", "GET_POLICY_BY_QUOTATION_NO", "GET_POLICY_BY_POLICY_NO"
                        With myobj_AL
                            ...
                            '.Insert(19, RTrim(myole_DR("TBIL_POL_PRM_PERIOD_YRS").ToString & vbNullString))

                            'If IsDate(myole_DR("TBIL_POL_PRM_FROM")) Then
                            '    .Insert(20, Format(CType(myole_DR("TBIL_POL_PRM_FROM"), DateTime), "dd/MM/yyyy"))
                            'Else
                            '    .Insert(20, "")
                            'End If
                            'If IsDate(myole_DR("TBIL_POL_PRM_TO")) Then
                            '    .Insert(21, Format(CType(myole_DR("TBIL_POL_PRM_TO"), DateTime), "dd/MM/yyyy"))
                            'Else
                            '    .Insert(21, "")
                            'End If

                            '.Insert(22, RTrim(myole_DR("TBIL_POL_PRM_RT_FIXED").ToString & vbNullString))
                            '.Insert(23, RTrim(myole_DR("TBIL_POL_PRM_RT_FIX_PER").ToString & vbNullString))

                            ' CEL 24 IS RESERVES FOR FACTOR

                            '.Insert(25, RTrim(myole_DR("TBIL_POLY_UNDW_YR").ToString & vbNullString))
                            '.Insert(26, RTrim(myole_DR("TBIL_INSRD_NAME").ToString & vbNullString))
                            '.Insert(27, RTrim(myole_DR("TBIL_PRDCT_DTL_DESC").ToString & vbNullString))
                            '.Insert(28, RTrim(myole_DR("TBIL_POLY_ASSRD_CD").ToString & vbNullString))
                            '.Insert(29, RTrim(myole_DR("TBIL_POLY_CUST_CODE").ToString & vbNullString))

                            '.Insert(30, RTrim(myole_DR("TBIL_POLY_BRANCH_CD").ToString & vbNullString))
                    ...
                    Case "GET_GL_POLICY_BY_FILE_NO", "GET_GL_POLICY_BY_QUOTATION_NO", "GET_GL_POLICY_BY_POLICY_NO"
                        With myobj_AL
                            ...
                            .Insert(22, RTrim(myole_DR("TBIL_POL_PRM_RT_FIXED").ToString & vbNullString))
                            .Insert(23, RTrim(myole_DR("TBIL_POL_PRM_RT_FIX_PER").ToString & vbNullString))
                            .Insert(24, RTrim(myole_DR("TBIL_POL_PRM_SA_FACTOR").ToString & vbNullString))
                            .Insert(25, RTrim(myole_DR("TBIL_POLY_UNDW_YR").ToString & vbNullString))
                            .Insert(26, RTrim(myole_DR("TBIL_INSRD_NAME").ToString & vbNullString))
                            .Insert(27, RTrim(myole_DR("TBIL_PRDCT_DTL_DESC").ToString & vbNullString))
                            .Insert(28, RTrim(myole_DR("TBIL_POLY_ASSRD_CD").ToString & vbNullString))
...
gnGet_SN_End:
    ...
    Public Function gnGet_Serial_No(ByVal pvCODE As String, ByVal pvRef_Type As String, _
        ...
        Select Case UCase(RTrim(pvCODE))
            ...
            Case "GET_SN_GL"
                Select Case RTrim(pvRef_Type)
                    Case "GL_MEMBER_SN", "GL_BENEF_SN", "GL_FUN_SN", "GL_FUN_COVER_SN"
...
gnGet_SN_End:
    ...
    Public Function gnGet_Serial_Num(ByVal pvCODE As String, ByVal pvRef_ProcDate As String, ByVal pvRef_BranchNum As String, ByVal pvRef_SectorNum As String, Optional ByVal pvRef_DC_Code As String = "D") As String
        ...
        Select Case RTrim(pvCODE)
            'General Business
            Case "INSURED_SN"
                gnSQL = "ABSSP_INSRDCNT_GET_SERIAL"
            Case "POLICY"
                gnSQL = "ABSSP_POLYCNT_GET_SERIAL"
            Case "MOTOR_FLEET_SN"
                gnSQL = "ABSSP_MFEET_GET_SERIAL"
            Case "DNCN_SN"
                gnSQL = "ABSSP_DBCRTAB_GET_SERIAL"
            Case "DNCN_INVOICE"
                gnSQL = "ABSSP_INVOICE_GET_UND"
            Case "CLAIM_SN_OUTSTD"
                gnSQL = "ABSSP_CLMRESV_GET_SERIAL"
            Case "CLAIM_SN_PAID"
                gnSQL = "ABSSP_CLMPAID_GET_SERIAL"
            Case "CLAIMS_INVOICE"
                gnSQL = "ABSSP_INVOICE_GET_CLM"
            Case "ACCOUNT_SN_RPJ"
                gnSQL = "ABSSP_GETGL_SERIAL_DTL"


                'Group life
            Case "DNCN_INVOICE_GRP_LIFE"
                gnSQL = "SPGL_GET_DNCN_INVOICE_NUM"
            Case "DNCN_SN_GRP_LIFE"
                gnSQL = "SPGL_GET_DNCN_SERIAL_NUM"
        ...
        Select Case pvCODE
            Case "INSURED_SN"
                objOLECmd.Parameters.Add("p01", OleDbType.VarChar, 3).Value = RTrim("001")
            Case "POLICY"
                objOLECmd.Parameters.Add("p01", OleDbType.VarChar, 3).Value = RTrim("003")
                objOLECmd.Parameters.Add("p02", OleDbType.VarChar, 10).Value = RTrim(pvRef_ProcDate)
                objOLECmd.Parameters.Add("p03", OleDbType.VarChar, 4).Value = RTrim(pvRef_BranchNum)
                objOLECmd.Parameters.Add("p04", OleDbType.VarChar, 10).Value = RTrim(pvRef_SectorNum)
            Case "MOTOR_FLEET_SN"
                objOLECmd.Parameters.Add("p01", OleDbType.VarChar, 3).Value = RTrim("001")
                objOLECmd.Parameters.Add("p02", OleDbType.VarChar, 10).Value = RTrim(pvRef_ProcDate)
                objOLECmd.Parameters.Add("p03", OleDbType.VarChar, 4).Value = RTrim(pvRef_BranchNum)
            Case "DNCN_SN"
                ...
                objOLECmd.Parameters.Add("p04", OleDbType.VarChar, 10).Value = RTrim(pvRef_SectorNum)
            Case "DNCN_INVOICE"
                objOLECmd.Parameters.Add("p01", OleDbType.VarChar, 3).Value = RTrim("100")
                objOLECmd.Parameters.Add("p02", OleDbType.VarChar, 2).Value = RTrim(pvRef_DC_Code)
            Case "CLAIM_SN_OUTSTD"
                objOLECmd.Parameters.Add("p01", OleDbType.VarChar, 3).Value = RTrim("003")
                objOLECmd.Parameters.Add("p02", OleDbType.VarChar, 10).Value = RTrim(pvRef_ProcDate)
                objOLECmd.Parameters.Add("p03", OleDbType.VarChar, 4).Value = RTrim(pvRef_BranchNum)
                objOLECmd.Parameters.Add("p04", OleDbType.VarChar, 10).Value = RTrim(pvRef_SectorNum)
            Case "CLAIM_SN_PAID"
                objOLECmd.Parameters.Add("p01", OleDbType.VarChar, 3).Value = RTrim("005")
                objOLECmd.Parameters.Add("p02", OleDbType.VarChar, 10).Value = RTrim(pvRef_ProcDate)
                objOLECmd.Parameters.Add("p03", OleDbType.VarChar, 4).Value = RTrim(pvRef_BranchNum)
                objOLECmd.Parameters.Add("p04", OleDbType.VarChar, 10).Value = RTrim(pvRef_SectorNum)
            Case "CLAIMS_INVOICE"
                objOLECmd.Parameters.Add("p01", OleDbType.VarChar, 3).Value = RTrim("200")
                objOLECmd.Parameters.Add("p02", OleDbType.VarChar, 2).Value = RTrim(pvRef_DC_Code)
            Case "ACCOUNT_SN_RPJ"
                objOLECmd.Parameters.Add("p01", OleDbType.VarChar, 3).Value = RTrim("001")
                objOLECmd.Parameters.Add("p02", OleDbType.VarChar, 10).Value = RTrim(pvRef_ProcDate)
                objOLECmd.Parameters.Add("p03", OleDbType.VarChar, 4).Value = RTrim(pvRef_BranchNum)
                objOLECmd.Parameters.Add("p04", OleDbType.VarChar, 10).Value = RTrim(pvRef_SectorNum)
                objOLECmd.Parameters.Add("p05", OleDbType.VarChar, 10).Direction = Data.ParameterDirection.Output
        ...
        Select Case RTrim(pvCODE)
            Case "ACCOUNT_SN_RPJ"
                intC = objOLECmd.ExecuteNonQuery()
                pvSerialNum = CType(objOLECmd.Parameters("p05").Value & vbNullString, String)
                GoTo gnGet_SN_End
        End Select
        ...
        If (objOLEDR.Read()) Then
            Select Case RTrim(pvCODE)
                ...
                Case "MOTOR_FLEET_SN"
                    pvSerialNum = CType(objOLEDR("automf_serial_num") & vbNullString, String)
                Case "DNCN_SN"
                    pvSerialNum = CType(objOLEDR("autodncn_serial_num") & vbNullString, String)
                Case "DNCN_INVOICE"
                    pvSerialNum = CType(objOLEDR("autodncn_invoice_num") & vbNullString, String)
                Case "CLAIM_SN_OUTSTD"
                    pvSerialNum = CType(objOLEDR("autocpo_serial_num") & vbNullString, String)
                Case "CLAIM_SN_PAID"
                    pvSerialNum = CType(objOLEDR("autocpo_serial_num") & vbNullString, String)
                Case "CLAIMS_INVOICE"
...
gnGet_SN_End:
    ...
    Public Sub gnPopulate_DropDownList(ByVal pvCODE As String, ByVal pvcboDDList As DropDownList, Optional ByVal pvSQL As String = "", _
        ...
        Select Case RTrim(pvCODE)
            ...
            Case "UND_MAIN_CLASS"
                ...
                pvListItem = New ListItem("Accident", "A")
                pvcboDDList.Items.Add(pvListItem)
                pvListItem = New ListItem("Engineering", "E")
                pvcboDDList.Items.Add(pvListItem)
                pvListItem = New ListItem("Fire", "F")
                pvcboDDList.Items.Add(pvListItem)
                pvListItem = New ListItem("Marine", "M")
                pvcboDDList.Items.Add(pvListItem)
                pvListItem = New ListItem("Motor", "V")
                pvcboDDList.Items.Add(pvListItem)
                pvListItem = New ListItem("Oil and Gas", "Z")
                pvcboDDList.Items.Add(pvListItem)
            ...
            Case "UND_RECORD_TYPE"
                pvcboDDList.Items.Clear()

                pvListItem = New ListItem("Underwriting Record", "A")
                pvcboDDList.Items.Add(pvListItem)
                'pvListItem = New ListItem("ORC/Admin Charges", "B")
                'pvcboDDList.Items.Add(pvListItem)
                pvListItem = New ListItem("Co-Ins (Leading)", "C")
                pvcboDDList.Items.Add(pvListItem)
                pvListItem = New ListItem("Co-Ins (Party in Bus.)", "D")
                pvcboDDList.Items.Add(pvListItem)
                pvListItem = New ListItem("Facultative Inward", "I")
                pvcboDDList.Items.Add(pvListItem)
                'pvListItem = New ListItem("Facultative Outward", "O")
                'pvcboDDList.Items.Add(pvListItem)
            ...
            Case "UND_BUS_TYPE"
                ...
                pvListItem = New ListItem("New Business", "NB")
                pvcboDDList.Items.Add(pvListItem)
                pvListItem = New ListItem("Additional Business", "AD")
                pvcboDDList.Items.Add(pvListItem)
                pvListItem = New ListItem("Renewal Business", "RW")
                pvcboDDList.Items.Add(pvListItem)
                pvListItem = New ListItem("Return Business", "RN")
                pvcboDDList.Items.Add(pvListItem)
                pvListItem = New ListItem("Reversal Business", "RV")
                pvcboDDList.Items.Add(pvListItem)
            ...
            Case "D-NOTE_C-NOTE"
                ...
                pvListItem = New ListItem("Debit Note", "D")
                pvcboDDList.Items.Add(pvListItem)
                pvListItem = New ListItem("Credit Note", "C")
                pvcboDDList.Items.Add(pvListItem)
            ...
            Case "GL_MEMEBER_CATEGORY"
                'Populate box with app module
                pvcboDDList.Items.Clear()

                pvListItem = New ListItem("Male", "M")
                pvcboDDList.Items.Add(pvListItem)
                pvListItem = New ListItem("Female", "F")
                pvcboDDList.Items.Add(pvListItem)
                pvListItem = New ListItem("Child", "C")
                pvcboDDList.Items.Add(pvListItem)
                pvListItem = New ListItem("Corporate", "P")
                pvcboDDList.Items.Add(pvListItem)
            ...
            Case "IL_CODE_TYPE", "GL_CODE_TYPE"
                'Populate box with app module
                pvcboDDList.Items.Clear()

                pvListItem = New ListItem("Nationality Codes Setup", "001")
                pvcboDDList.Items.Add(pvListItem)
                pvListItem = New ListItem("State Codes Setup", "002")
                pvcboDDList.Items.Add(pvListItem)
                pvListItem = New ListItem("Branch Codes Setup", "003")
                pvcboDDList.Items.Add(pvListItem)
                pvListItem = New ListItem("Division Codes Setup", "004")
                pvcboDDList.Items.Add(pvListItem)
                pvListItem = New ListItem("Department Codes Setup", "005")
                pvcboDDList.Items.Add(pvListItem)
                pvListItem = New ListItem("Location Codes Setup", "006")
                pvcboDDList.Items.Add(pvListItem)
                pvListItem = New ListItem("Occupation Class Setup", "007")
                pvcboDDList.Items.Add(pvListItem)
                pvListItem = New ListItem("Occupation Codes Setup", "008")
                pvcboDDList.Items.Add(pvListItem)
                pvListItem = New ListItem("Religion/Belief Codes Setup", "009")
                pvcboDDList.Items.Add(pvListItem)
                pvListItem = New ListItem("Customer Title Codes Setup", "010")
                pvcboDDList.Items.Add(pvListItem)
                pvListItem = New ListItem("Rider Codes Setup", "011")
                pvcboDDList.Items.Add(pvListItem)
                pvListItem = New ListItem("Charge Codes Setup", "012")
                pvcboDDList.Items.Add(pvListItem)
                pvListItem = New ListItem("Relation Codes Setup", "013")
                pvcboDDList.Items.Add(pvListItem)
                pvListItem = New ListItem("Source of Business Codes Setup", "014")
                pvcboDDList.Items.Add(pvListItem)
                pvListItem = New ListItem("Gender Codes Setup", "015")
                pvcboDDList.Items.Add(pvListItem)
                pvListItem = New ListItem("Agency Location Setup", "016")
                pvcboDDList.Items.Add(pvListItem)
                pvListItem = New ListItem("Currency Codes Setup", "017")
                pvcboDDList.Items.Add(pvListItem)
                pvListItem = New ListItem("Marital Status", "020")
                pvcboDDList.Items.Add(pvListItem)
            ...
            Case "IL_INS_MODULE_LIST", "IL_BRK_MODULE_LIST", "GL_INS_MODULE_LIST", "GL_BRK_MODULE_LIST"
                'Populate box with app module
                pvcboDDList.Items.Clear()
        ...
        Select Case RTrim(pvCODE)
            ...
            Case "INSURED_CODE", "IL_ASSURED_LIST", "IL_ASSURED_HELP_SP"
                If Val(pvlngCnt) = 0 Then
            ...
            Case "GL_ASSURED_LIST", "GL_ASSURED_HELP_SP", "GL_ASSURED_HELP_SP_DNCN"
                If Val(pvlngCnt) = 0 Then
                    pvcboDDList.Items.Insert(0, New ListItem("* Name not found *", pvDefault_Value))
                Else
                    pvcboDDList.Items.Insert(0, New ListItem(pvDefault_Text, pvDefault_Value))
            ...
            Case "IL_BROKERS_LIST", "IL_BROKERS_LIST_GL", "GL_BROKERS_LIST"
                If Val(pvlngCnt) = 0 Then
    ...
    Public Sub gnProc_Populate_Box(ByVal pvCODE As String, ByVal pvTransType As String, ByVal pvcboList As DropDownList, Optional ByVal pvSearchValue As String = "", Optional ByVal pvSQL_Query As String = "")
        ...
        Select Case UCase(Trim(pvCODE))
            ...
            Case "SECTOR_CODE"
                ...
                strTable = RTrim("ABSBUSECTAB")
                strSQL = ""
                strSQL = "SELECT CTBS_NUM AS MyFld_Value, CTBS_LONG_DESCR AS MyFld_Text"
                strSQL = strSQL & " FROM " & strTable
                strSQL = strSQL & " WHERE CTBS_ID = '" & RTrim(pvTransType) & "'"
            ...
            Case "IL_CODE_LIST_UND", "GL_CODE_LIST_UND"
                strTable = strTableName
                strTable = RTrim("TBIL_LIFE_CODES")
                strSQL = ""
                strSQL = strSQL & "SELECT TBIL_COD_ITEM AS MyFld_Value, TBIL_COD_LONG_DESC AS MyFld_Text"
            ...
            Case "GL_COVER_LIST_ADD_COVER_HEADER"
                strTable = strTableName
                strTable = RTrim("TBIL_GRP_POLICY_ADD_PREM")
                strSQL = ""
                strSQL = pvSQL_Query
                Call gnPopulate_DropDownList(pvCODE, pvcboList, strSQL, "", "(Select item)", "*")
            ...
            Case "GL_ASSURED_HELP_SP_DNCN"
                strTable = "TBIL_GRP_POLICY_DET"
                strSQL = ""
                strSQL = RTrim("SPGL_GET_INSURED_DNCN")
                Call gnPopulate_DropDownList(pvCODE, pvcboList, strSQL, RTrim(pvSearchValue), "* select insured *", "*")
            ...
            Case "IL_BROKERS_LIST_GL"
                ...
                strSQL = strSQL & " AND TBIL_CUST_MDLE IN('GRP','G')"
                strSQL = strSQL & " AND TBIL_CUST_DESC LIKE '" & RTrim(pvSearchValue) & "%'"
                strSQL = strSQL & " ORDER BY TBIL_CUST_DESC"
                Call gnPopulate_DropDownList(pvCODE, pvcboList, strSQL, "", "*** select broker name ***", "*")

            Case "GL_BROKERS_LIST"
                strTable = "TBIL_CUST_DETAIL"
                strSQL = ""
                strSQL = "SELECT TBIL_CUST_CODE AS MyFld_Value"
                strSQL = strSQL & ",RTRIM(ISNULL(TBIL_CUST_DESC,'')) AS MyFld_Text"
...
MyTestDate_Err1:
    ...
    Public Function gnUpdate_Treaty(ByVal fnCODE As String, ByVal fnYear As String, _
ByVal fnSubRisk_Num As String, _
ByVal fnTreatyRef_Num As TextBox, _
ByVal fnTreatyRef_Descr As TextBox, _
ByVal fnSum_Ins As Double, _
ByVal fnPremium As Double, _
ByVal fnLC_SI As TextBox, _
ByVal fnLC_Rate As TextBox, _
ByVal fnRet_SI As TextBox, _
ByVal fnRet_Rate As TextBox, _
ByVal fnSurp1_SI As TextBox, _
ByVal fnSurp1_Rate As TextBox, _
ByVal fnSurp2_SI As TextBox, _
ByVal fnSurp2_Rate As TextBox, _
ByVal fnQuota_SI As TextBox, _
ByVal fnQuota_Rate As TextBox, _
ByVal fnFacBal As TextBox, _
ByVal fnFacBal_Rate As TextBox) As Boolean

        'On Error GoTo gnUpdate_Trt_Err

        gnUpdate_Treaty = False
        ...
        '        'Retrieve and validate underwriting year
        '        '---------------------------------------
        '        gnYear = Trim(fnYear)
        '        If Len(Trim(fnYear)) = 0 Or _
        '           Trim(fnYear) = "" Then
        '            'MsgBox("Error: Missing Underwriting Year...", , "Treaty Update Error")
        '            Exit Function
        '        End If
        '        If Len(Trim(fnYear)) <> 4 Then
        '            'MsgBox("Error: Incomplete data for Underwriting Year...", , "Treaty Update Error")
        '            Exit Function
        '        End If

        '        'Retrieve and validate sub-risk code
        '        '-----------------------------------
        '        gnSubRisk_Num = fnSubRisk_Num
        '        'gnSubRisk_Num = fnTreatyRef_Num
        '        If Len(Trim(fnSubRisk_Num)) = 0 Or _
        '           Trim(fnSubRisk_Num) = "" Then
        '            'MsgBox("Error!. " & vbCrLf & _
        '            '  "Missing SUBRISK code. Please enter valid SUBRISK code...", , _
        '            '    "AutoTreaty Update Error")
        '            Exit Function
        '        End If
        ...
        '        '--------------------
        '        If Not IsNumeric(fnSum_Ins) Then
        '            'MsgBox("Error: Sum Insured not numeric...", , "Treaty Update Error")
        '            Exit Function
        '        End If
        '        If fnSum_Ins = 0 And _
        '           Trim(fnCODE) = "1" Then
        '            'MsgBox("Error: Missing Sum Insured...", , "Treaty Update Error")
        '            Exit Function
        '        End If
        '        If fnSum_Ins = 0 And _
        '           Trim(fnCODE) = "0" Then
        ...
        '        'Set parameters to connect to database table
        '        '-------------------------------------------
        '        'Dim pvadoRS As ADODB.Recordset
        '        'pvadoRS = New ADODB.Recordset
        '        'If pvadoRS.State = adStateOpen Then
        '        '    pvadoRS.Close()
        '        'End If

        '        'fnTreatyRef_Num
        '        gnSQL = ""
        '        'gnSQL = "SELECT * FROM " & RiskApp_Tbl & " WHERE " & _
        '        '  "RAPP_ID = '001'" & _
        '        '  " AND RAPP_YEAR = '" & fnYear & "'" & _
        '        '  " AND RAPP_RISK_NUM = '" & fnTreatyRef_Num.Text & "'"
        '        'pvadoRS.Open gnSQL, fnCon.ABS_CON, _
        '        '  adOpenDynamic, adLockOptimistic, adCmdText

        '        'gnCmd = New ADODB.Command
        '        'With gnCmd
        '        '.ActiveConnection = fnCon
        '        '.CommandType = adCmdStoredProc
        '        '.CommandText = "ABSSP_RISKAPPAUTO_SELECT_AUTO"

        '        '.Parameters.Append.CreateParameter("PN01", adChar, adParamInput, 3, "001")
        '        '.Parameters.Append.CreateParameter("PN01", adChar, adParamInput, 4, Trim(fnYear))
        '        '.Parameters.Append.CreateParameter("PN01", adChar, adParamInput, 4, Trim(fnSubRisk_Num))
        '        'pvadoRS = .Execute
        '        'End With
        '        'gnCmd = Nothing
        '        'TrtCmd = Nothing

        '        gnSQL = "ABSSP_RISKAPPAUTO_SELECT_AUTO"
        ...
        '        objOLECmd.Parameters.Add("p01", OleDbType.VarChar, 3).Value = RTrim("001")
        '        objOLECmd.Parameters.Add("p02", OleDbType.VarChar, 4).Value = RTrim(fnYear)
        '        objOLECmd.Parameters.Add("p03", OleDbType.VarChar, 4).Value = RTrim(fnSubRisk_Num)
        ...
        '        objOLEDR = objOLECmd.ExecuteReader(System.Data.CommandBehavior.CloseConnection)
        '        If (objOLEDR.Read()) Then
        '            fnTreatyRef_Descr.Text = RTrim(objOLEDR("RAPP_DESCR").ToString & vbNullString)
        '            fnTreatyRef_Num.Text = RTrim(objOLEDR("RAPP_RISK_NUM").ToString & vbNullString)

        '            'Load Treaty Info
        '            '----------------
        '            gnLc_Rate = Format(objOLEDR("RAPP_LC_RATE"), "##0.00")
        '            gnRet_SI = Format(objOLEDR("RAPP_RET_SI"), "##########0.00")
        '            gnSurp1_Amt = Format(objOLEDR("RAPP_SURP1_SI"), "##########0.00")
        '            gnSurp2_Amt = Format(objOLEDR("RAPP_SURP2_SI"), "##########0.00")

        '            gnQuota_Rate = Format(objOLEDR("RAPP_QUOTA_CEDING"), "##0.00")
        '            gnQuota_Rate = Format(objOLEDR("RAPP_QUOTA_TREATY"), "##0.00")
        '            gnQuota_Limit = Format(objOLEDR("RAPP_QUOTA_LIMIT"), "##########0.00")

        '            gnRet_RateQ = Format(objOLEDR("RAPP_QUOTA_CEDING"), "##0.00")

        '            strOpt = Trim(objOLEDR("RAPP_OPT") & vbNullString)
        '        Else
        '            GoTo gnUpdate_Trt_End

        '        End If

        '        'Update treaty variables
        '        '-----------------------
        '        gnSI_Amt = Format(fnSum_Ins, "##########0.00")
        '        gnSI_Rate = Format(100.0#, "##########0.00")
        '        gnPrem_Amt = Format(fnPremium, "##########0.00")

        '        'Test for Treaty Type:
        '        ' 1 => Surplus treaty
        '        ' 2 => Quota share treaty
        '        '--------------------
        '        If Trim(strOpt) = "1" Then
        '            gnQuota_Flag = "T"

        '            gnQuota_Rate = 0
        '            gnQuota_SI = 0
        '            GoTo gnUpdate_Surplus
        '        End If
        '        If Trim(strOpt) = "2" Then
        '            gnQuota_Flag = "Q"
        '            gnRet_Rate = gnRet_RateQ
        ...
        '        'MsgBox("Error!. Invalid treaty type... - " & strOpt, vbCritical, "Error - gnUpdate_Treaty")
        '        gnUpdate_Treaty = False
        '        GoTo gnUpdate_Trt_End
        ...
        '        End If
        '        If gnLc_Rate > 0 And gnSI_Amt > 0 Then
        '            gnLc_SI = gnLc_Rate * gnSI_Amt / 100
        '        End If

        '        'For retension SI
        '        '----------------
        '        gnTrans_Amt = 0
        '        gnTrans_Amt = gnSI_Amt - gnLc_SI
        '        If gnTrans_Amt >= gnRet_SI Then
        '            gnTrans_Amt = gnTrans_Amt - gnRet_SI
        '            gnRet_Rate = gnRet_SI / gnSI_Amt * 100
        '        Else
        '            gnTrans_Amt = 0
        '            'gnRet_SI = 0
        '            gnRet_Rate = 100
        ...
        '            gnSurp2_Rate = 0
        '            gnFacBal_Amt = 0
        '            GoTo gnUpdate_Trt_OK
        '        End If

        '        'For first surplus SI
        '        '--------------------
        '        If gnTrans_Amt >= gnSurp1_Amt Then
        '            gnTrans_Amt = gnTrans_Amt - gnSurp1_Amt
        '            gnSurp1_Rate = gnSurp1_Amt / gnSI_Amt * 100
        '        Else
        '            'gnTrans_Amt = 0
        '            gnSurp1_Amt = gnTrans_Amt
        '            gnSurp1_Rate = gnSurp1_Amt / gnSI_Amt * 100
        '            gnSurp2_Amt = 0
        '            gnSurp2_Rate = 0
        '            gnFacBal_Amt = 0
        ...
        '        'For second surplus SI
        '        '---------------------
        '        'If gnTrans_Amt >= gnSurp2_Amt Then
        '        '   gnTrans_Amt = gnTrans_Amt - gnSurp2_Amt
        '        '   gnSurp2_Rate = gnSurp2_Amt / gnSI_Amt * 100
        '        'Else
        '        '   'gnTrans_Amt = 0
        '        '   gnSurp2_Amt = gnTrans_Amt
        '        '   gnSurp2_Rate = gnSurp2_Amt / gnSI_Amt * 100
        '        '   gnFacBal_Amt = 0
        '        '   GoTo gnUpdate_Trt_OK
        '        'End If

        '        gnFacBal_Amt = gnTrans_Amt
        '        gnFac_Rate = gnFacBal_Amt / gnSI_Amt * 100

        '        GoTo gnUpdate_Trt_OK

        'gnUpdate_Quota:
        '        If gnSI_Amt > gnQuota_Limit Then
        '            gnQuota_SI = gnQuota_Rate * gnQuota_Limit / 100
        '            'gnRet_SI = gnRet_Rate * gnQuota_Limit / 100
        '        Else
        '            gnQuota_SI = gnQuota_Rate * gnSI_Amt / 100
        '            'gnRet_SI = gnRet_Rate * gnSI_Amt / 100
        '        End If

        '        'MsgBox "Company Ret. SI : " & gnRet_SI & vbCrLf & _
        '        '  "Treaty Quota SI: " & gnQuota_SI
        ...
        '        fnLC_SI.Text = Format(gnLc_SI, "##########0.00")
        '        fnLC_Rate.Text = Format(gnLc_Rate, "##0.00")

        '        fnRet_SI.Text = Format(gnRet_SI, "##########0.00")
        '        fnRet_Rate.Text = Format(gnRet_Rate, "##0.00")

        '        fnSurp1_SI.Text = Format(gnSurp1_Amt, "##########0.00")
        '        fnSurp1_Rate.Text = Format(gnSurp1_Rate, "##0.00")

        '        fnSurp2_SI.Text = Format(gnSurp2_Amt, "##########0.00")
        '        fnSurp2_Rate.Text = Format(gnSurp2_Rate, "##0.00")

        '        fnQuota_SI.Text = Format(gnQuota_SI, "##########0.00")
        '        fnQuota_Rate.Text = Format(gnQuota_Rate, "##0.00")

        '        fnFacBal.Text = Format(gnFacBal_Amt, "##########0.00")
        '        fnFacBal_Rate.Text = Format(gnFac_Rate, "##0.00")

        '        gnUpdate_Treaty = True
        '        pvbln = True
...
gnUpdate_Trt_Err:
        ...
        '        If Err.Number = 3021 And _
        '           Trim(fnCODE) = "1" Then
        '            'MsgBox("Error!." & vbCrLf & _
        '            '  "No Re-Insurance treaty distribution setup for this business." & vbCrLf & vbCrLf & _
        '            '  fnSubRisk_Num & " - " & "Subrisk...", vbCritical, _
        '            '  "Treaty Distribution Error")
        '        End If
        '        If Err.Number = 3021 And _
        '           Trim(fnCODE) = "0" Then
        '            gnUpdate_Treaty = True
        ...
        '            '  "Description:" & Err.Description, vbCritical, _
        '            '  "Auto Risk Distribution Error")
        '        End If
    ...
    Public Function gnValidate_Codes(ByVal pvCODE As String, ByVal pvRef_Value As TextBox, ByVal pvRef_Text As TextBox, _
        ...
        Select Case RTrim(pvCODE)
            ...
            Case "INSURED_CODE_LIFE"
                ...
                gnSQL = gnSQL & " AND INSRD.TBIL_INSRD_MDLE IN('IND','I')"

            Case "INSURED_CODE_LIFE_GL"
                gnTable = "TBIL_INS_DETAIL"
                gnSQL = ""
                gnSQL = gnSQL & "SELECT TOP 1 INSRD.TBIL_INSRD_CODE, INSRD.TBIL_INSRD_SURNAME, INSRD.TBIL_INSRD_FIRSTNAME"
                gnSQL = gnSQL & " ,INSRD.TBIL_INSRD_ADRES1, INSRD.TBIL_INSRD_ADRES2"
                ...
                gnSQL = gnSQL & " WHERE INSRD.TBIL_INSRD_CODE = '" & RTrim(pvRef_Value.Text) & "'"
                gnSQL = gnSQL & " AND INSRD.TBIL_INSRD_ID IN('001')"
                gnSQL = gnSQL & " AND INSRD.TBIL_INSRD_MDLE IN('GRP','G')"
            ...
            Case "AGENCY_UND_LIFE", "AGENCY_CODE_LIFE"
                ...
                Select Case RTrim(pvCODE)
                    Case "AGENCY_UND_LIFE"
                        ...
                        gnSQL = gnSQL & " AND AGCY.TBIL_AGCY_CD_MDLE IN('IND','I','GRP','G')"
                        'gnSQL = gnSQL & " AND RIGHT(RTRIM(CTAGCY_NUM),3) NOT IN('/SO','/FO')"
            ...
            Case "BROKER_UND_LIFE", "BROKER_CODE_LIFE"
                ...
                Select Case RTrim(pvCODE)
                    Case "BROKER_UND_LIFE"
                        ...
                        gnSQL = gnSQL & " AND BRK.TBIL_CUST_MDLE IN('IND','I','GRP','G')"
                        'gnSQL = gnSQL & " AND RIGHT(RTRIM(CTAGCY_NUM),3) NOT IN('/SO','/FO')"
        ...
        If (objOLEDR.Read()) Then
            Select Case RTrim(pvCODE)
                ...
                Case "INSURED_CODE_LIFE", "INSURED_CODE_LIFE_GL"
    ...
    Public Function GET_INSURED_DCNOTE(ByVal sValue As String, ByVal DNCN As String) As DataSet
        ...
        Dim cmd As OleDbCommand = New OleDbCommand()
        cmd.Connection = conn
        cmd.CommandText = "SPGL_GET_INSURED_DNCN"
        cmd.CommandType = CommandType.StoredProcedure
        cmd.Parameters.AddWithValue("@PARAM_01", sValue)
        cmd.Parameters.AddWithValue("@PARAM_02", sValue)
        cmd.Parameters.AddWithValue("@PARAM_TYPE", "GRP")
        cmd.Parameters.AddWithValue("@PARAM_DRCR_CODE", DNCN)
        Try
            conn.Open()
            Dim adapter As OleDbDataAdapter = New OleDbDataAdapter()
            adapter.SelectCommand = cmd
