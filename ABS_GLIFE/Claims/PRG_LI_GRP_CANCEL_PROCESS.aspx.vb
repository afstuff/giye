...
Imports System.Data
Imports System.IO
Partial Class Claims_PRG_LI_GRP_CANCEL_PROCESS
    ...
    Private Sub GetPolicyDetails(ByVal PolicyNo As String)
        ...
        Try
            ...
            If objOLEReader.HasRows = True Then
                ...
                Dim daydiff = GetDayDiff(Convert.ToDateTime(MOD_GEN.DoConvertToDbDateFormat(txtPolicyStartDate.Text)), Now)
                If daydiff > 31 Then
    ...
    Protected Sub cmdPrint_ASP_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles cmdPrint_ASP.Click
        Response.Redirect("PRG_LI_GRP_CANCEL_PROCESS_RPT.aspx")
    End Sub
