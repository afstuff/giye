<%@ Page Language="VB" AutoEventWireup="false" CodeFile="PRG_LI_GRP_REVIVE_POLICY.aspx.vb" Inherits="Claims_PRG_LI_GRP_REVIVE_POLICY" %>
        ...
        $('#txtPolReviveDate').blur(function(e) {
            ...
            if ($('#txtPolReviveDate').val() != "") {
                ...
                if (res == true) {
                    ...
                    alert("Not a valid revive date date format")
