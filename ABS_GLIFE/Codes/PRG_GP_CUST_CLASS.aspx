<%@ Page Language="VB" AutoEventWireup="false" CodeFile="PRG_GP_CUST_CLASS.aspx.vb" Inherits="PRG_GP_CUST_CLASS" %>
                    ...
                    <table align="center" border="0" cellpadding="1" cellspacing="1"  class="tbl_menu_new">
                	    ...
                	    <tr>
                            ...
                            <td align="right" valign="top">
                                &nbsp;<a class="a_return_menu" href="#" onclick="javascript:JSDO_RETURN('../MENU_GL.aspx?menu=gl_code_cust')">Returns to Previous Page</a>&nbsp;
                            </td>
    	               	</tr>

                		<tr>
    	                    <td align="right" nowrap><asp:Label ID="lblCustType" Enabled="false" Text="Record ID:" runat="server"></asp:Label>&nbsp;</td>
            	    	    <td align="left" nowrap colspan="1"><asp:textbox id="txtCustType" Enabled="false" MaxLength="3" Width="50px" runat="server" EnableViewState="true"></asp:textbox></td>
                		...
                		<tr>
    	                    <td align="right" nowrap><asp:Label ID="lblCustNum" Text="Insured Class Code:" runat="server"></asp:Label>&nbsp;</td>
                		...
                		<tr>
    		                <td align="right" nowrap><asp:Label ID="lblCustName" Text="Insured Class Description:" runat="server"></asp:Label>&nbsp;</td>
                        ...
                        <tr>
                            <td align="left" colspan="4" valign="top">
                                <asp:GridView id="GridView1" CellPadding="2" runat="server" CssClass="grd_ctrl"
                                    DataKeyNames="TBIL_INS_CLASS_REC_ID" HorizontalAlign="Left"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:BoundField readonly="true" DataField="TBIL_INS_CLASS_REC_ID" HeaderText="Ref.No" HeaderStyle-HorizontalAlign="Left" convertemptystringtonull="true" />
                                        <asp:BoundField readonly="true" DataField="TBIL_INS_CLASS_TYPE" HeaderText="Ref.Type" HeaderStyle-HorizontalAlign="Left" convertemptystringtonull="true" />
                                        <asp:BoundField readonly="true" DataField="TBIL_INS_CLASS_CD" HeaderText="Trans Code" HeaderStyle-HorizontalAlign="Left" convertemptystringtonull="true" />
                                        <asp:BoundField readonly="true" DataField="TBIL_INS_CLASS_DESC" HeaderText="Trans Description" HeaderStyle-HorizontalAlign="Left" convertemptystringtonull="true" />
                                    </Columns>
