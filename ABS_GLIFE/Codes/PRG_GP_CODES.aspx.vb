...
Partial Class PRG_GP_CODES
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Not (Page.IsPostBack) Then
            Me.txtGroupNum.Text = ""
            'Call Proc_Populate_Box("IL_CODE_TYPE", Trim(Me.txtGroupNum.Text), Me.ddlGroup)
            Call Proc_Populate_Box("GL_CODE_TYPE", Trim(Me.txtGroupNum.Text), Me.ddlGroup)
            If Trim(strP_TYPE) = "ALL" Then
            Else
                Me.txtGroupNum.Text = RTrim(strP_TYPE)
    ...
    Protected Sub txtNum_TextChanged(ByVal sender As Object, ByVal e As EventArgs) Handles txtNum.TextChanged
        If Trim(Me.txtGroupNum.Text) <> "" And Trim(Me.txtNum.Text) <> "" Then
    ...
    Private Sub DoSave()
        ...
        Call Proc_DataBind()
        Call Proc_Populate_Box("IL_CODE_LIST", Trim(Me.txtGroupNum.Text), Me.ddlTrans)
        Call DoNew()
    ...
    Private Function Proc_OpenRecord(ByVal strRefNo As String, Optional ByVal strSearchByWhat As String = "MY_TRANS_NUM") As String
        ...
        If (objOLEDR.Read()) Then
            ...
            Call Proc_DDL_Get(Me.ddlTrans, RTrim(Me.txtNum.Text))
    ...
    Protected Sub ddlGroup_SelectedIndexChanged(ByVal sender As Object, ByVal e As EventArgs) Handles ddlGroup.SelectedIndexChanged
        ...
        strP_DESC = RTrim(Me.ddlGroup.SelectedItem.Text)

        If RTrim(Me.txtGroupNum.Text) = "" Or RTrim(Me.txtGroupNum.Text) = "*" Then
            Me.txtRecNo.Text = "0"
            Me.txtGroupNum.Text = ""
            Me.txtNum.Text = ""
        ...
        Else
            ...
            Call Proc_DataBind()
            'Call Proc_Populate_Box("IL_CODE_LIST", Trim(Me.txtGroupNum.Text), Me.ddlTrans)
            Call Proc_Populate_Box("GL_CODE_LIST", Trim(Me.txtGroupNum.Text), Me.ddlTrans)
        End If

    End Sub

    Protected Sub ddlTrans_SelectedIndexChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles ddlTrans.SelectedIndexChanged
        'Me.txtGroupNum.Text = RTrim(Me.ddlGroup.SelectedItem.Value)
        Me.txtNum.Text = RTrim(Me.ddlTrans.SelectedItem.Value)
