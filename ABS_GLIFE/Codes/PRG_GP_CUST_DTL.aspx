<%@ Page Language="VB" AutoEventWireup="false" CodeFile="PRG_GP_CUST_DTL.aspx.vb" Inherits="PRG_GP_CUST_DTL" %>
                    ...
                    <table align="center" border="0" cellpadding="1" cellspacing="1"  class="tbl_menu_new">
                        ...
                        <tr>
                            ...
                            <td align="right" valign="top">
                                &nbsp;<a id="PageAnchor_Return_Link" runat="server" class="a_return_menu" href="#" onclick="javascript:JSDO_RETURN('../MENU_GL.aspx?menu=gl_code_cust')">Returns to Previous Page</a>
                                &nbsp;<%=PageLinks%>&nbsp;
                            </td>
    	               	</tr>

                        <tr id="tr_close_list" runat="server">
                            <td align="left" colspan="4" valign="top"><b>Data Search List</b> &nbsp;&nbsp;
                                <asp:button id="cmdClear" Font-Bold="true" runat="server" text="Close Data List..."></asp:button>
                            </td>                                
                        </tr>
