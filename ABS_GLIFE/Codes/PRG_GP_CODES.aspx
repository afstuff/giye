<%@ Page Language="VB" AutoEventWireup="false" CodeFile="PRG_GP_CODES.aspx.vb" Inherits="PRG_GP_CODES" %>
                    ...
                    <table border="0" width="100%">
                        <tr style="display: none;">
                            <td align="right"  colspan="2" valign="top" style="display: none;">
                                &nbsp;<a class="HREF_MENU2" href="#" onclick="javascript:JSDO_RETURN('../MENU_GL.aspx?menu=GL_CODE')">Returns to Previous Page</a>&nbsp;
                            </td>
            ...
            <table align="center" border="0" cellpadding="1" cellspacing="1"  class="tbl_menu_new">
                ...
                <tr>
                    ...
                    <td align="right" valign="top">
                        &nbsp;<a id="PageAnchor_Return_Link" runat="server" class="a_return_menu" href="#" onclick="javascript:JSDO_RETURN('../MENU_GL.aspx?menu=GL_CODE')">Returns to Previous Page</a>
                        &nbsp;<%=PageLinks%>
                    </td>
                </tr>    
                ...
                <tr>
                    ...
                    <td align="left" valign="top" colspan="3">
                        ...
                        &nbsp;<asp:DropDownList ID="ddlGroup" AutoPostBack="true" runat="server" Width="300px"></asp:DropDownList>
                        ...
                        &nbsp;<asp:TextBox ID="txtRecNo" Enabled="false" runat="server" MaxLength="18" Width="100px"></asp:TextBox>
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <td align="left" valign="top" colspan="3">
                        ...
                        &nbsp;<asp:DropDownList ID="ddlTrans" AutoPostBack="true" runat="server" Width="350px"></asp:DropDownList>
                    </td>                    
                </tr>
                ...
                <tr>
                    ...
                    <table align="center" border="0" style="background-color: White; width: 95%;">
                        <tr>
                            <td align="left" colspan="6" valign="top">
                                <div class="div_grid">
                                <asp:GridView id="GridView1" CellPadding="2" runat="server" CssClass="grd_ctrl"
                                    DataKeyNames="TBIL_COD_REC_ID" HorizontalAlign="Left" PageSize="30"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:BoundField readonly="true" DataField="TBIL_COD_REC_ID" HeaderText="RecID" HeaderStyle-HorizontalAlign="Left" convertemptystringtonull="true" />
                                        <asp:BoundField readonly="true" DataField="TBIL_COD_TYP" HeaderText="Type" HeaderStyle-HorizontalAlign="Left" convertemptystringtonull="true" />
                                        ...
                                        <asp:BoundField readonly="true" DataField="TBIL_COD_LONG_DESC" HeaderText="Description" HeaderStyle-HorizontalAlign="Left" convertemptystringtonull="true" />
                                    </Columns>
