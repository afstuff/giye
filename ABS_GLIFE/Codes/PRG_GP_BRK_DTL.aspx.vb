...
Partial Class PRG_GP_BRK_DTl
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Not (Page.IsPostBack) Then
            ...
            Call Proc_Populate_Box("GL_BRK_MODULE_LIST", Trim("001"), Me.cboCustModule)
            Call Proc_Populate_Box("GL_BRK_CLASS_LIST", Trim("001"), Me.cboCustCateg)
            'Call Proc_Populate_Box("GL_BRK_DETAIL_LIST", Trim(Me.txtCustID.Text), Me.cboTransList)
            Call Proc_DataBind()
            Call DoNew()
    ...
    Protected Sub Proc_Populate_Box(ByVal pvCODE As String, ByVal pvTransType As String, ByVal pvcboList As DropDownList)
        ...
        Select Case UCase(Trim(pvCODE))
            ...
            Case "IL_BRK_DETAIL_LIST"
                ...
                strSQL = strSQL & " AND TBIL_CUST_MDLE IN('INV','I','GRP','G')"
    ...
    Private Sub Proc_DataBind()
        ...
        If C >= 1 Then
            ...
            Call Proc_Populate_Box("GL_BRK_DETAIL_LIST", Trim("001"), Me.cboTransList)
        Else
            Me.tr_close_list.Visible = False
