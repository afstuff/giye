<%@ Page Language="VB" AutoEventWireup="false" CodeFile="PRG_LI_GRP_POLY_ADD_COVER.aspx.vb" Inherits="Policy_PRG_LI_GRP_POLY_ADD_COVER" %>
...
<body onload="<%= FirstMsg %>">
    ...
    <div id="div_content" align="center">
        <table class="tbl_cont" align="center">
                <tr>
                    <td nowrap class="myheader">Additional Covers Header Information</td>
                </tr>
                <tr>
                        ...
                        <table align="center" border="0" class="tbl_menu_new">
                            ...
                            <tr>
                                                ...
                                                <td align="left" valign="top" colspan="3">
                                                    <asp:TextBox ID="txtBatch_Num" MaxLength="10" Enabled="false" Width="80px" runat="server"></asp:TextBox>
                                                </td>
                            </tr>
                                    ...
                                    <tr style="display: none;">
                                                ...
                                                <td align="left" valign="top" colspan="1"><asp:TextBox ID="txtDOB_ANB" Enabled="false" Width="40px" runat="server"></asp:TextBox>
                                                </td>
                                    </tr>
                                    ...
                                    <tr>
                                        <td align="left" colspan="4" valign="top" class="myMenu_Title">Additional Covers Header</td>
                                    </tr>
                                ...
                                <td align="left" colspan="4" class="td_frame">
                                    <table align="center" border="1">
                                        <tr class="tr_frame">
                                                ...
                                                <td align="left" valign="top" colspan="1"><asp:Label ID="lblAdd_No_Prem_Yr" Text="Paid Prem for No of Years" runat="server"></asp:Label></td>
                                                <td align="left" valign="top" colspan="1"><asp:Label ID="lblAdd_Same_SA_Or_Diff" Text="Same SA or Different SA for Member" ToolTip="Same SA for all Member or Different SA Member" runat="server"></asp:Label></td>
                                        </tr>
                                        <tr style="font-size: small;">
                                                ...
                                                <td align="left" valign="top" colspan="1"><asp:TextBox ID="txtAdd_No_Prem_Yr" MaxLength="3" runat="server"></asp:TextBox></td>
                                           <td align="left" valign="top" colspan="1">
                                                <asp:DropDownList ID="cboAdd_Same_SA_Or_Diff" Width="200px" runat="server">
                                                    <asp:ListItem Selected="True" Value="*">(Select item)</asp:ListItem>
                                                    <asp:ListItem Value="G">Same SA for all members</asp:ListItem>
                                                    <asp:ListItem Value="I">Different SA for Members</asp:ListItem>
                                                </asp:DropDownList>
                                                &nbsp;<asp:TextBox ID="txtAdd_Same_SA_Or_Diff" Visible="false" Enabled="false" Width="40px" MaxLength="3" ToolTip="Same SA for all Member or Different SA Member" runat="server"></asp:TextBox>
                                                &nbsp;<asp:TextBox ID="txtAdd_Same_SA_Or_DiffName" Visible="false" Enabled="false" Width="40px" runat="server"></asp:TextBox>
                                           </td>
                                        </tr>
                                        ...
                                        <tr class="tr_frame">
                                            <td align="left" valign="top" colspan="3"><asp:Label ID="lblAdd_Prem_Rate_Code" Text="Premium Rate Code" runat="server"></asp:Label></td>
                                            <td align="left" valign="top" colspan="2"><asp:Label ID="lblAdd_Prem_Rate" Enabled="false" Text="Prem Rate" runat="server"></asp:Label></td>
                                        </tr>
                                        
                                        <tr style="font-size: small;">
                                            <td align="left" valign="top" colspan="3">
                                                <asp:DropDownList ID="cboAdd_Prem_Rate_Code" Width="400px" runat="server" AutoPostBack="true" OnTextChanged="DoProc_Premium_Code_Change">
                                                </asp:DropDownList>
                                            ...
                                            <td align="left" valign="top" colspan="2"><asp:TextBox ID="txtAdd_Prem_Rate" Enabled="false" Width="80px" runat="server"></asp:TextBox>
                                        ...
                                        <tr class="tr_frame">
                                           <td align="left" valign="top"><asp:Label ID="lblAdd_SA_RT_AMT_CD" Text="SA % of Basic SA or Amount" runat="server"></asp:Label></td>
                                           <td align="left" valign="top" colspan="1"><asp:Label ID="lblAdd_PCENT_SA" Text="% of Basic SA" runat="server"></asp:Label></td>
                                            ...
                                            <td align="left" valign="top" colspan="2"><asp:Label ID="lblAdd_SA_FC" Enabled="false" Text="Sum Assured FC" ToolTip="FC=Foreign Currency" runat="server"></asp:Label></td>
                                        </tr>
                                        
                                        <tr style="font-size: small;">
                                           <td align="left" valign="top">
                                                <asp:DropDownList ID="cboAdd_SA_RT_AMT_CD" Width="140px" runat="server">
                                                    <asp:ListItem Selected="True" Value="*">(Select item)</asp:ListItem>
                                           ...
                                           <td align="left" valign="top" colspan="1"><asp:TextBox ID="txtAdd_PCENT_SA" Enabled="true" MaxLength="15" runat="server"></asp:TextBox>
                                           </td>
                                           <td align="left" valign="top"><asp:TextBox ID="txtAdd_SA_LC" MaxLength="15" runat="server"></asp:TextBox></td>
                                           <td align="left" valign="top" colspan="2"><asp:TextBox ID="txtAdd_SA_FC" Enabled="false" MaxLength="15" runat="server"></asp:TextBox></td>
                                        </tr>
                                            ...
                                            <td align="left" colspan="4" valign="top">
                                                <asp:GridView id="GridView1" CellPadding="2" runat="server" CssClass="grd_ctrl"
                                                    ...
                                                    <Columns>
                                                        ...
                                                        <asp:BoundField readonly="true" DataField="TBIL_COV_DESC" HeaderText="File Number" HeaderStyle-HorizontalAlign="Left" convertemptystringtonull="true" />
                                                        ...
                                                        <asp:BoundField readonly="true" DataField="TBIL_POL_ADD_PREM_SA_GRP_MEMB" HeaderText="Type" HeaderStyle-HorizontalAlign="Left" convertemptystringtonull="true" />
                                                        ...
                                                        <asp:BoundField readonly="true" DataField="TBIL_POL_ADD_PCENT_SA" HeaderText="PCent Rate" HeaderStyle-HorizontalAlign="Left" convertemptystringtonull="true" />
                                                    </Columns>
