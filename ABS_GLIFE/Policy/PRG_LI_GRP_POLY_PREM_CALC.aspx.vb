...
Partial Class Policy_PRG_LI_GRP_POLY_PREM_CALC
    ...
    Dim dblLoading_Prem As Double = 0
    Dim dblLoading_Misc_Prem As Double = 0
    Dim dblDiscount_Prem As Double = 0
    Dim dblDiscount_Misc_Prem As Double = 0
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        strTableName = "TBIL_GRP_POLICY_PREM_DETAILS"
        ...
        'add_cov
        Try
            strGO_SW = CType(Request.QueryString("go"), String)
        ...
        If Not (Page.IsPostBack) Then
            ...
            If Trim(strF_ID) <> "" Then
                ...
                If oAL.Item(0) = "TRUE" Then
                    ...
                    If Trim(oAL.Item(20).ToString) <> "" Then
                        ...
                        Me.txtTrans_Date.Text = Format(GenStart_Date, "dd/MM/yyyy")
                    End If
                    Me.txtUWYear.Text = oAL.Item(25)

                    Me.txtBraNum.Text = oAL.Item(30).ToString
                    Me.txtDeptNum.Text = oAL.Item(31).ToString
            ...
            Call DoProc_CreateDataSource("GL_PRODUCT_CAT_LIST", Trim("G"), Me.cboProductClass)
            ...
            If Me.cboProductClass.SelectedIndex = -1 Or Me.cboProductClass.SelectedIndex = 0 Then
                ...
                Call gnProc_DDL_Get(Me.cboProductClass, RTrim("G=") & RTrim(Me.txtProductClass.Text))
            End If

            Call DoProc_CreateDataSource("GL_PRODUCT_DET_LIST", Me.txtProductClass.Text, Me.cboProduct)

            Call gnProc_Populate_Box("GL_COVER_LIST", RTrim(Me.txtProduct_Num.Text), Me.cboCover_Name)
    ...
    Private Sub Proc_DoSave()
        ...
        'End If
        strSQL = strSQL & " AND TBIL_POL_PRM_DTL_MEMB_BATCH_NO = '" & RTrim(Me.txtBatch_Num.Text) & "'"
        ...
        Try
            ...
            If obj_DT.Rows.Count = 0 Then
                ...
                '
                drNewRow("TBIL_POL_PRM_DTL_MDLE") = RTrim("G")
                ...
                drNewRow("TBIL_POL_PRM_DTL_UNDW_YR") = RTrim(Me.txtUWYear.Text)
                drNewRow("TBIL_POL_PRM_DTL_MEMB_BATCH_NO") = RTrim(Me.txtBatch_Num.Text)

                drNewRow("TBIL_POL_PRM_DTL_BRANCH_CD") = RTrim(Me.txtBraNum.Text)
                drNewRow("TBIL_POL_PRM_DTL_DEPT_CD") = RTrim(Me.txtDeptNum.Text)
                ...
                drNewRow("TBIL_POL_PRM_DTL_MOP_FACTOR") = RTrim(Me.txtCalc_MOP_Factor_LC.Text)
                ...
                ' next
                drNewRow("TBIL_POL_PRM_DTL_MOP_CONTRB_LC") = Val(txtCalc_MOP_Contrib_LC.Text)
                drNewRow("TBIL_POL_PRM_DTL_MOP_CONTRB_FC") = Val(txtCalc_MOP_Contrib_FC.Text)
                ...
                drNewRow("TBIL_POL_PRM_DTL_FIRST_PRM_LC") = Val(txtCalc_First_Prem_LC.Text)
                drNewRow("TBIL_POL_PRM_DTL_FIRST_PRM_FC") = Val(txtCalc_First_Prem_FC.Text)
            ...
            Else
                ...
                With obj_DT
                    .Rows(0)("TBIL_POL_PRM_DTL_MDLE") = RTrim("G")
                    ...
                    .Rows(0)("TBIL_POL_PRM_DTL_UNDW_YR") = RTrim(Me.txtUWYear.Text)
                    .Rows(0)("TBIL_POL_PRM_DTL_MEMB_BATCH_NO") = RTrim(Me.txtBatch_Num.Text)

                    .Rows(0)("TBIL_POL_PRM_DTL_BRANCH_CD") = RTrim(Me.txtBraNum.Text)
                    .Rows(0)("TBIL_POL_PRM_DTL_DEPT_CD") = RTrim(Me.txtDeptNum.Text)
                    ...
                    ' next
                    .Rows(0)("TBIL_POL_PRM_DTL_MOP_CONTRB_LC") = Val(txtCalc_MOP_Contrib_LC.Text)
                    .Rows(0)("TBIL_POL_PRM_DTL_MOP_CONTRB_FC") = Val(txtCalc_MOP_Contrib_FC.Text)
                    ...
                    .Rows(0)("TBIL_POL_PRM_DTL_FIRST_PRM_LC") = Val(txtCalc_First_Prem_LC.Text)
                    .Rows(0)("TBIL_POL_PRM_DTL_FIRST_PRM_FC") = Val(txtCalc_First_Prem_FC.Text)
    ...
    Private Function Proc_DoOpenRecord(ByVal FVstrGetType As String, ByVal FVstrRefNum As String, Optional ByVal FVstrRecNo As String = "", Optional ByVal strSearchByWhat As String = "FILE_NUM") As String
        ...
        strSQL = strSQL & " LEFT JOIN TBIL_GRP_POLICY_PREM_INFO " & " AS PRM"
        ...
        strSQL = strSQL & " AND CALC_TBL.TBIL_POL_PRM_DTL_MEMB_BATCH_NO = '" & RTrim(Me.txtBatch_Num.Text) & "'"

        strSQL = strSQL & " AND CALC_TBL.TBIL_POL_PRM_DTL_PROP_NO = '" & RTrim("XYZ") & "'"
        ...
        If (objOLEDR.Read()) Then
            ...
            If RTrim(CType(objOLEDR("TBIL_POL_PRM_DTL_UNDW_YR") & vbNullString, String)) <> "" Then
                Me.txtUWYear.Text = RTrim(CType(objOLEDR("TBIL_POL_PRM_DTL_UNDW_YR") & vbNullString, String))
            End If
            ...
            Me.txtBatch_Num.Text = RTrim(CType(objOLEDR("TBIL_POL_PRM_DTL_MEMB_BATCH_NO") & vbNullString, String))
        ...
        Else
            ...
            'strSQL = "SPIL_GET_POLICY_PREM_INFO"
            'strSQL = "SPGL_GET_POLICY_PREM_INFO"
            ...
            If (objOLEDR.Read()) Then
                ...
                'Call gnProc_DDL_Get(Me.cboProductClass, RTrim("IND=") & RTrim(Me.txtProductClass.Text))
                Call gnProc_DDL_Get(Me.cboProductClass, RTrim(CType(objOLEDR("TBIL_PRDCT_DTL_MDLE") & vbNullString, String)) & RTrim("=") & RTrim(Me.txtProductClass.Text))
                'Me.cboProductClass.Enabled = True
                'If Me.cboProductClass.SelectedIndex = -1 Or Me.cboProductClass.SelectedIndex = 0 Then
                'Call gnProc_DDL_Get(Me.cboProductClass, RTrim("I=") & RTrim(Me.txtProductClass.Text))
                'End If
    ...
    Private Sub Proc_DoCalc_Prem()
        ...
        strDoc_Item_SQL = "DELETE FROM TBIL_GRP_POLICY_DOC_ITEMS"
        ...
        strDoc_Item_SQL = strDoc_Item_SQL & " and TBIL_POL_ITEM_MDLE = '" & RTrim("G") & "'"
        ...
        'TBIL_POL_MEMB_TOT_SA()
        'TBIL_POL_PRM_DTL_SA_LC()

        'TBIL_POL_MEMB_PRO_RATE_PREM()
        'TBIL_POL_PRM_DTL_BASIC_ANN_PRM_LC()

        'TBIL_ADD_COV_MEMB_PRO_RATE_PREM()
        'TBIL_POL_PRM_DTL_ADDPREM_LC()

        'TBIL_POL_MEMB_LOAD()
        'TBIL_POL_PRM_DTL_LOADING_LC()
        ...
        If (objMem_DR.Read()) Then
            Me.txtCalc_SA_LC.Text = Val(objMem_DR("TOT_SA") & vbNullString)
            Me.txtCalc_Ann_Basic_Prem_LC.Text = Val(objMem_DR("TOT_PREM") & vbNullString)
            dblLoading_Prem = Val(objMem_DR("TOT_LOADING") & vbNullString)
        Else
            Me.txtCalc_SA_LC.Text = Val(0).ToString
            Me.txtCalc_Ann_Basic_Prem_LC.Text = Val(0).ToString
            dblLoading_Prem = Val(0)
        End If

        'Do While objMem_DR.Read()
        '    'Response.Write("<br/>Rate: " & objMem_DR("TOT_SA"))
        '    dblSum_Assured_LC = dblSum_Assured_LC + objMem_DR("TOT_SA")
        'Loop

        Me.txtCalc_SA_FC.Text = Me.txtCalc_SA_LC.Text

        Me.txtCalc_Ann_Contrib_LC.Text = Me.txtCalc_SA_LC.Text
        Me.txtCalc_Ann_Contrib_FC.Text = Me.txtCalc_Ann_Contrib_LC.Text

        txtCalc_Life_Cover_SA_LC.Text = Me.txtCalc_SA_LC.Text
        txtCalc_Life_Cover_SA_FC.Text = txtCalc_Life_Cover_SA_LC.Text
        ...
        myRetValue = MOD_GEN.gnGET_RATE("GET_GL_MOP_FACTOR", "GRP", Me.txtCalc_MOP_Factor_LC.Text, "", "", "", Me.lblMsg, Nothing, Me.txtPrem_MOP_Per)
        ...
        ' -------------------------
        ' START GROUP LIFE SKIP OTHERS CALCULATIONS
        ' ------------------------
        Dim strMy_Skip As String = ""
        strMy_Skip = "Y"

        dblSum_Assured_LC = Val(Me.txtCalc_SA_LC.Text)
        dblSum_Assured_FC = Val(Me.txtCalc_SA_FC.Text)

        dblAnnual_Basic_Prem_LC = Val(Me.txtCalc_Ann_Basic_Prem_LC.Text)
        dblAnnual_Basic_Prem_FC = Val(Me.txtCalc_Ann_Basic_Prem_FC.Text)


        If strMy_Skip = "Y" Then
            GoTo START_ADD_PREM_RTN
        End If

        ' -------------------------
        ' END GROUP LIFE SKIP OTHERS CALCULATIONS
        ' ------------------------
        ...
        Select Case Trim(Me.txtProduct_Num.Text)
            Case "F001", "F002"
                ...
                If dblAnnual_Contrib_LC <> 0 And dblMOP_Per <> 0 Then
...
Skip_C001:
        ...
        Select Case UCase(Me.txtProduct_Num.Text)
            ...
            Case "I004", "E003"
                'I004 - Personal provident
                'E003 - LIFE TIME HARVEST
...
ESU_RTN_START:
        ...
        strSQL = strSQL & " AND ESU_TBL.TBIL_ESU_RT_MDLE IN('GRP','G')"
...
START_ADD_PREM_RTN:
        ...
        dblTotal_Load_Prem_LC = 0
        dblTotal_Load_Prem_FC = 0

        dblTotal_Disc_Prem_LC = 0
        dblTotal_Disc_Prem_FC = 0

        Call Proc_DoCalc_Loading(objOLEConn, RTrim(Me.txtBatch_Num.Text))
        Call Proc_DoCalc_Discount(objOLEConn, RTrim(Me.txtBatch_Num.Text))
        ...
        dblTotal_Charges_LC = 0
        dblTotal_Charges_FC = 0
        ...
        Do While objOLEDR_CHG.Read()
            ...
            Select Case UCase(Trim(CType(objOLEDR_CHG("TBIL_POLY_CHG_APPLD_ON") & vbNullString, String)))
                ...
                Case "P"    'compute premium base on basic premium
                    dblTmp_Amt = 0
                    dblTmp_AmtX = dblAnnual_Basic_Prem_LC + dblTotal_Add_Prem_LC
                    If Val(dblTmp_AmtX) <> 0 And Val(dblCharges_Rate) <> 0 And Val(dblCharges_Rate_Per) <> 0 Then
                        dblTmp_Amt = dblTmp_AmtX * dblCharges_Rate / dblCharges_Rate_Per
                    End If
                    dblTotal_Charges_LC = dblTotal_Charges_LC + dblTmp_Amt
...
START_MOP_RTN:
        ...
        Dim my_MOP_SKIP As String = ""
        my_MOP_SKIP = "Y"
        If UCase(my_MOP_SKIP) = "Y" Then
            GoTo END_MOP_RTN
        End If
        ...
        Select Case Trim(Me.txtPrem_Rate_Applied_On.Text)
            Case "P"
                ...
                dblMOP_Prem_LC = dblMOP_Contrib_FC
...
END_MOP_RTN:
    ...
    Private Sub Proc_DoCalc_Discount(ByVal pv_objOLEConn As OleDbConnection, Optional ByVal pvBatch_Num As String = "")

        '***********************************************************************************************
        ' START LOADING AND DISCOUNT CODES 
        '***********************************************************************************************
        ...
        Do While objOLEDR_DL.Read()
            ...
            Select Case UCase(Trim(CType(objOLEDR_DL("TBIL_POL_DISC_LOAD_INV_GRP") & vbNullString, String)))
                Case "I"    ' INDIVIDUAL
                        ...
                        Case "F"    'USE FIXED RATE
                            Select Case UCase(Trim(CType(objOLEDR_DL("TBIL_POL_DISC_LOAD_TYPE") & vbNullString, String)))
                                Case "D"    ' DISCOUNT
                                    ...
                                    If Val(dblTmp_AmtX) <> 0 And Val(dblDisc_Load_Percent) <> 0 And Val(dblDisc_Load_Rate_Per) <> 0 Then
                                        dblTmp_Amt = dblTmp_AmtX * dblDisc_Load_Percent / dblDisc_Load_Rate_Per
                                    End If
                                    dblTotal_Disc_Amt_LC = dblTotal_Disc_Amt_LC + dblTmp_Amt
                        ...
                        Case "R"    'USE RATE RATE
                            Select Case UCase(Trim(CType(objOLEDR_DL("TBIL_POL_DISC_LOAD_TYPE") & vbNullString, String)))
                                Case "D"    ' DISCOUNT
                                    ...
                                    If Val(dblTmp_AmtX) <> 0 And Val(dblDisc_Load_Prem_Rate) <> 0 And Val(dblDisc_Load_Rate_Per) <> 0 Then
                                        dblTmp_Amt = dblTmp_AmtX * dblDisc_Load_Prem_Rate / dblDisc_Load_Rate_Per
                                    End If
                                    dblTotal_Disc_Amt_LC = dblTotal_Disc_Amt_LC + dblTmp_Amt
    ...
    Private Sub Proc_DoCalc_Loading(ByVal pv_objOLEConn As OleDbConnection, Optional ByVal pvBatch_Num As String = "")
    ...
    Private Sub Proc_DoCalc_AddPrem(ByVal pv_objOLEConn As OleDbConnection, Optional ByVal pvCover_Flag As String = "")
        ...
        strSQL = strSQL & " WHERE ADD_TBL.TBIL_ADD_COV_MEMB_FILE_NO = '" & RTrim(strREC_ID) & "'"
        strSQL = strSQL & " AND ADD_TBL.TBIL_ADD_COV_MEMB_PROP_NO = '" & RTrim(strQ_ID) & "'"
        'strSQL = strSQL & " AND ADD_TBL.TBIL_ADD_COV_MEMB_POLY_NO = '" & RTrim(strP_ID) & "'"
        strSQL = strSQL & " AND ADD_TBL.TBIL_ADD_COV_MEMB_BATCH_NO = '" & RTrim(Me.txtBatch_Num.Text) & "'"
        strSQL = strSQL & " AND ADD_TBL.TBIL_ADD_COV_MEMB_STATUS IN('Q')"
        ...
        Do While objOLEDR.Read()
            ...
            strCover_Num = RTrim(CType(objOLEDR("TBIL_ADD_COV_MEMB_CD") & vbNullString, String))
            ...
            If IsNumeric(CType(objOLEDR("TBIL_ADD_COV_MEMB_SA") & vbNullString, String)) Then
                dblItem_SA = CType(objOLEDR("TBIL_ADD_COV_MEMB_SA") & vbNullString, Double)
            End If
            dblAdd_Prem_SA_LC = dblItem_SA
            dblAdd_Prem_SA_FC = dblAdd_Prem_SA_LC

            If IsNumeric(CType(objOLEDR("TBIL_ADD_COV_MEMB_PREM") & vbNullString, String)) Then
                'dblAdd_Prem_Amt = CType(objOLEDR("TBIL_ADD_COV_MEMB_PREM") & vbNullString, Double)
            End If
            If IsNumeric(CType(objOLEDR("TBIL_ADD_COV_MEMB_PRO_RATE_PREM") & vbNullString, String)) Then
                dblAdd_Prem_Amt = CType(objOLEDR("TBIL_ADD_COV_MEMB_PRO_RATE_PREM") & vbNullString, Double)
            End If
        ...
        If UCase(RTrim(pvCover_Flag)) = "ADD_COV" And UCase(Trim(strDoc_Item_Flag)) <> "Y" Then
            ...
            strCover_Num = ""
            Call Proc_DoSave_DocItem("ADD_COV", strCover_Num, 0, pv_objOLEConn)
        End If
    ...
    Private Sub Proc_DoCalc_AddPrem_Old(ByVal pv_objOLEConn As OleDbConnection, Optional ByVal pvCover_Flag As String = "")
        ...
        strSQL = ""
        strSQL = strSQL & "SELECT ADD_TBL.*"
        strSQL = strSQL & ",MEMB.TBIL_POL_MEMB_TOT_SA, MEMB.TBIL_POL_MEMB_PREM, MEMB.TBIL_POL_MEMB_PRO_RATE_PREM"

        strSQL = strSQL & " FROM " & strTable & " AS ADD_TBL"
        strSQL = strSQL & " LEFT JOIN TBIL_GRP_POLICY_MEMBERS AS MEMB"
        strSQL = strSQL & " ON MEMB.TBIL_POL_MEMB_FILE_NO = ADD_TBL.TBIL_POL_ADD_FILE_NO"
        strSQL = strSQL & " AND MEMB.TBIL_POL_MEMB_PROP_NO = ADD_TBL.TBIL_POL_ADD_PROP_NO"
        strSQL = strSQL & " AND MEMB.TBIL_POL_MEMB_BATCH_NO = '" & RTrim(Me.txtBatch_Num.Text) & "' "
        ...
        Do While objOLEDR.Read()
            ...
            Select Case UCase(Trim(CType(objOLEDR("TBIL_POL_ADD_PREM_RT_AMT_CD") & vbNullString, String)))
                Case "A"    'Fixed Amount
                    ...
                    Select Case Trim(CType(objOLEDR("TBIL_POL_ADD_PREM_SA_GRP_MEMB") & vbNullString, String))
                        Case "G" ' Same SA for all members
                        Case "I" ' Different SA for Members
                    End Select
                ...
                Case "F"    'Fixed Rate
                    ...
                    If IsNumeric(CType(objOLEDR("TBIL_POL_MEMB_PREM") & vbNullString, String)) Then
                        dblAdd_Prem_Amt = CType(objOLEDR("TBIL_POL_MEMB_PREM") & vbNullString, Double)
                    End If

                    Select Case Trim(CType(objOLEDR("TBIL_POL_ADD_PREM_SA_GRP_MEMB") & vbNullString, String))
                        Case "G" ' Same SA for all members
                        Case "I" ' Different SA for Members
                            If IsNumeric(CType(objOLEDR("TBIL_POL_MEMB_TOT_SA") & vbNullString, String)) Then
                                dblAdd_Prem_SA_LC = CType(objOLEDR("TBIL_POL_MEMB_TOT_SA") & vbNullString, Double)
                            End If
                    ...
                    Select Case Trim(CType(objOLEDR("TBIL_POL_ADD_RATE_APPLY") & vbNullString, String))
                        Case "P"    'compute additional premium base on basic premium
                            ...
                            'End If
                            If Val(dblAdd_Prem_Amt) <> 0 And Val(dblAdd_Prem_Rate) <> 0 And Val(dblAdd_Rate_Per) <> 0 Then
                                dblTmp_Amt = dblAdd_Prem_Amt * dblAdd_Prem_Rate / dblAdd_Rate_Per
                            End If
                            dblTotal_Add_Prem_LC = dblTotal_Add_Prem_LC + dblTmp_Amt
    ...
    Private Function Proc_DoLoading(ByVal pv_objOLEConn As OleDbConnection, ByVal pvRate_Type As String, ByVal pvApplied_On As String, ByVal pvLoad_Amt As Double, ByVal pvLoad_Rate As Double, ByVal pvLoad_Rate_Per As Integer, ByVal pvLoad_Percent As Double) As Double
        ...
        mystr = ""
        mystr = "SELECT TBIL_POL_MEMB_REC_ID, TBIL_POL_MEMB_SNO, TBIL_POL_MEMB_TOT_SA, TBIL_POL_MEMB_PREM, TBIL_POL_MEMB_PRO_RATE_PREM "
        ...
        myCNT = 0
        'For myCNT = 1 To myCNT_T

        '    myRID = oAL_ID.Item(myCNT - 1)
        '    myResult = CType(oAL_Rec.Item(myCNT - 1), Double)

        '    mystr = ""
        '    mystr = "update " & strTable
        '    mystr = mystr & " set TBIL_POL_MEMB_LOAD = '" & Val(myResult) & "'"
        '    mystr = mystr & " WHERE TBIL_POL_MEMB_FILE_NO = '" & RTrim(txtFileNum.Text) & "'"
        '    mystr = mystr & " AND TBIL_POL_MEMB_PROP_NO = '" & RTrim(txtQuote_Num.Text) & "'"
        '    mystr = mystr & " AND TBIL_POL_MEMB_BATCH_NO = '" & RTrim(txtBatch_Num.Text) & "'"
        '    mystr = mystr & " AND TBIL_POL_MEMB_REC_ID = '" & Val(myRID) & "'"
        '    'mystr = mystr & " AND TBIL_POL_MEMB_SNO = '" & Val(mySN) & "'"
        '    mystr = mystr & " AND TBIL_POL_MEMB_STATUS IN('Q')"

        '    myole_cmd = New OleDbCommand(mystr, pv_objOLEConn)
        '    myC = myole_cmd.ExecuteNonQuery
...
Proc_End_Rtn:
    ...
    Private Function Proc_DoLoading_Add_Member(ByVal pv_objOLEConn As OleDbConnection, ByVal pvRate_Type As String, ByVal pvApplied_On As String, ByVal pvLoad_Amt As Double, ByVal pvLoad_Rate As Double, ByVal pvLoad_Rate_Per As Integer, ByVal pvLoad_Percent As Double, ByVal pvCover_Num As String) As Double
        ...
        '    mystr = ""
        '    mystr = "update " & strTable
        '    mystr = mystr & " set TBIL_ADD_COV_MEMB_LOAD = '" & Val(myResult) & "'"
        '    mystr = mystr & " WHERE TBIL_ADD_COV_MEMB_FILE_NO = '" & RTrim(txtFileNum.Text) & "'"
        '    mystr = mystr & " AND TBIL_ADD_COV_MEMB_PROP_NO = '" & RTrim(txtQuote_Num.Text) & "'"
        '    mystr = mystr & " AND TBIL_ADD_COV_MEMB_BATCH_NO = '" & RTrim(txtBatch_Num.Text) & "'"
        '    mystr = mystr & " AND TBIL_ADD_COV_MEMB_CD = '" & RTrim(txtCover_Num.Text) & "'"
        '    mystr = mystr & " AND TBIL_ADD_COV_MEMB_REC_ID = '" & Val(myRID) & "'"
        '    'mystr = mystr & " AND TBIL_ADD_COV_MEMB_SNO = '" & Val(mySN) & "'"
        '    mystr = mystr & " AND TBIL_ADD_COV_MEMB_STATUS IN('Q')"
...
Proc_End_Rtn:
    ...
    Private Sub Proc_DoSave_DocItem(ByVal pvRecType As String, ByVal pvCoverNum As String, ByVal pvTransAmt As Double, ByVal pv_objOLEConn As OleDbConnection)
        ...
        strDoc_Item_SQL = "INSERT INTO TBIL_GRP_POLICY_DOC_ITEMS (TBIL_POL_ITEM_MDLE"
        ...
        strDoc_Item_SQL = strDoc_Item_SQL & " ,TBIL_POL_ITEM_AMT"
        ...
        strDoc_Item_SQL = strDoc_Item_SQL & " VALUES(" & RTrim("'G'")
    ...
    Protected Sub cmdPrev_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles cmdPrev.Click
        ...
        Dim pvURL As String = ""
        pvURL = "prg_li_indv_poly_load_disc.aspx?q=x"
        pvURL = "prg_li_grp_poly_load_disc.aspx?q=x"
        ...
        Select Case LCase(strGO_SW)
            Case "add_cov"
                pvURL = "prg_li_grp_poly_members_add.aspx?q=x&optbatno=" & Me.txtBatch_Num.Text
        End Select
    ...
    Protected Sub cmdNext_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles cmdNext.Click
        ...
        Dim pvURL As String = ""
        pvURL = "prg_li_indv_poly_prem_calc.aspx?q=x"
        pvURL = "prg_li_grp_poly_prem_calc.aspx?q=x"
        'pvURL = pvURL & "&optfileid=" & Trim(Me.txtFileNum.Text)
        'pvURL = pvURL & "&optpolid=" & Trim(Me.txtPolNum.Text)
        'pvURL = pvURL & "&optquotid=" & Trim(Me.txtQuote_Num.Text)
        'Response.Redirect(pvURL)
