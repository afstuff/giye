<%@ Page Language="VB" AutoEventWireup="false" CodeFile="PRG_LI_GRP_POLY_PREM_CALC.aspx.vb" Inherits="Policy_PRG_LI_GRP_POLY_PREM_CALC" %>
...
<head runat="server">
    <title>IGroup Life Premium Calculation</title>
                    ...
                    <td align="center" valign="top" class="td_menu">
                        <table align="center" border="0" class="tbl_menu_new">
                            ...
                            <tr>
                                    ...
                                    <tr>
                                                <td align="right"><asp:Label ID="lblBatch_Num" Enabled="false" Text="Batch Number" runat="server"></asp:Label></td>
                                                <td align="left"><asp:TextBox ID="txtBatch_Num" Enabled="false" runat="server"></asp:TextBox></td>
                                                <td align="right" valign="top"><asp:Label ID="lblUWYear" Enabled="false" Text="U/W Year:" runat="server"></asp:Label></td>
                                                <td align="left" valign="top" colspan="1"><asp:TextBox ID="txtUWYear" Enabled="false" MaxLength="4" Width="70" runat="server"></asp:TextBox>
                                                </td>
                                    </tr>
                            ...
                            <tr>
                                ...
                                <td align="left" valign="top"><asp:TextBox ID="txtBraNum" Visible="true" Enabled="false" MaxLength="4" Width="80px" runat="server"></asp:TextBox></td>
                                <td align="right" valign="top"><asp:Label ID="lblDeptNum" Text="Department:" runat="server"></asp:Label></td>
                                <td align="left" valign="top"><asp:TextBox ID="txtDeptNum" Visible="true" Enabled="false" MaxLength="4" runat="server" Width="80px"></asp:TextBox></td>
                            </tr>
