<%@ Page Language="VB" AutoEventWireup="false" CodeFile="PRG_LI_GRP_POLY_CHARGES.aspx.vb" Inherits="Policy_PRG_LI_GRP_POLY_CHARGES" %>
                                        ...
                                        <tr style="font-size: small;">
                                                ...
                                                <td align="left" valign="top" colspan="1">
                                                    <asp:DropDownList ID="cboChg_Applied_On" Width="150px" runat="server">
                                                        ...
                                                        <asp:ListItem Value="A">Direct Value</asp:ListItem>                                                    
