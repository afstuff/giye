...
Partial Class PRG_LI_GRP_POLY_PERSNAL
    ...
    Protected Sub DoProc_Assured_Search()
        If RTrim(Me.txtAssured_Search.Text) <> "" Then
            Call gnProc_Populate_Box("GL_ASSURED_LIST", "001", Me.cboAssured_Search, RTrim(Me.txtAssured_Search.Text))
        End If
    End Sub
    ...
    Protected Sub DoProc_Broker_Search()
        If RTrim(Me.txtBroker_Search.Text) <> "" Then
            Call gnProc_Populate_Box("IL_BROKERS_LIST_GL", "001", Me.cboBroker_Search, RTrim(Me.txtBroker_Search.Text))
        End If
    ...
    Protected Sub DoProc_Validate_Assured()
        ...
        Else
            blnStatus = gnValidate_Codes("INSURED_CODE_LIFE_GL", Me.txtAssured_Num, Me.txtAssured_Name)
            If blnStatus = False Then
...
SKIP_Next_88:
        ...
        If Trim(txtFileNum.Text) = "" Then
            ...
            Me.txtFileNum.Text = MOD_GEN.gnGet_Serial_File_Proposal_Policy(RTrim("GET_SN_GL_FIL_PRO_POL"), RTrim("FIL"), Trim(myYear), RTrim("GL"), RTrim(Me.txtBraNum.Text), RTrim(Me.txtProductClass.Text), RTrim(Me.txtProduct_Num.Text), RTrim("G"), RTrim(""), RTrim(""))
        End If
        ...
        If Trim(txtQuote_Num.Text) = "" Then
            ...
            Me.txtQuote_Num.Text = MOD_GEN.gnGet_Serial_File_Proposal_Policy(RTrim("GET_SN_GL_FIL_PRO_POL"), RTrim("PRO"), Trim(myYear), RTrim("GL"), RTrim(Me.txtBraNum.Text), RTrim(Me.txtProductClass.Text), RTrim(Me.txtProduct_Num.Text), RTrim("G"), RTrim(""), RTrim(""))
        End If
        ...
        Try
            ...
            If obj_DT.Rows.Count = 0 Then
                ...
                drNewRow("TBIL_POLY_MDLE") = RTrim("G")
...
PUpdate_Date1:
    ...
    Private Function Proc_DoOpenRecord(ByVal FVstrGetType As String, ByVal FVstrRefNum As String, Optional ByVal FVstrRecNo As String = "", Optional ByVal strSearchByWhat As String = "FILE_NUM") As String
        ...
        If (objOLEDR.Read()) Then
            ...
            Call gnProc_DDL_Get(Me.cboProductClass, RTrim(CType(objOLEDR("TBIL_PRDCT_DTL_CAT") & vbNullString, String)) & RTrim("=") & RTrim(Me.txtProductClass.Text))
            ...
            Me.txtRetirement_Age.Text = RTrim(CType(objOLEDR("TBIL_POLY_RETIREMENT_AGE") & vbNullString, String))
