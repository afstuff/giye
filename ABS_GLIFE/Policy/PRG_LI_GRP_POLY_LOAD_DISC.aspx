<%@ Page Language="VB" AutoEventWireup="false" CodeFile="PRG_LI_GRP_POLY_LOAD_DISC.aspx.vb" Inherits="Policy_PRG_LI_GRP_POLY_LOAD_DISC" %>
                                    ...
                                    <table align="center" border="1" style="width: 100%">
                                        ...
                                        <tr style="font-size: small;">
                                            ...
                                            <td align="left" valign="top">
                                                ...
                                                &nbsp;<asp:TextBox ID="txtLoad_Disc_Type" Enabled="false" Width="30px" runat="server"></asp:TextBox>
                                                &nbsp;<asp:TextBox ID="txtLoad_Disc_TypeName" Visible="false" Enabled="false" Width="30px" runat="server"></asp:TextBox></td>
                                            <td align="left" valign="top" colspan="1">
                                        ...
                                        <tr class="tr_frame">
                                            ...
                                            <td align="left" valign="top" colspan="1"><asp:Label ID="lblLoad_Disc_Mode" Text="Applied Method" ToolTip="Applied to Individual or Group" runat="server"></asp:Label>
                                            </td>
                                            <td align="left" valign="top" colspan="1"><asp:Label ID="lblLoad_Disc_SA_LC" Text="Sum Assured LC" ToolTip="LC=Local Currency" runat="server"></asp:Label>
                                            </td>
                                        ...
                                        <tr style="font-size: small;">
                                            <td align="left" valign="top" colspan="2">
                                                ...
                                                &nbsp;<asp:TextBox ID="txtLoad_Disc_Num" Visible="false" Enabled="false" Width="40px" runat="server"></asp:TextBox>
                                                &nbsp;<asp:TextBox ID="txtLoad_Disc_NumName" Visible="false" Enabled="false" Width="40px" runat="server"></asp:TextBox>
                                           </td>
                                           <td align="left" valign="top" colspan="1">
                                                <asp:DropDownList ID="cboLoad_Disc_Mode" Width="200px" runat="server">
                                                    <asp:ListItem Selected="True" Value="*">(Select item)</asp:ListItem>
                                                    <asp:ListItem Value="I">Individual</asp:ListItem>
                                                    <asp:ListItem Value="G">Group</asp:ListItem>
                                                </asp:DropDownList>
                                                &nbsp;<asp:TextBox ID="txtLoad_Disc_Mode" Visible="false" Enabled="false" Width="40px" MaxLength="3" ToolTip="Applied to Individual or Group" runat="server"></asp:TextBox>
                                                &nbsp;<asp:TextBox ID="txtLoad_Disc_ModeName" Visible="false" Enabled="false" Width="40px" runat="server"></asp:TextBox>
                                           </td>
                                           <td align="left" valign="top" colspan="1"><asp:TextBox ID="txtLoad_Disc_SA_LC" MaxLength="15" runat="server"></asp:TextBox>
                                           </td>
