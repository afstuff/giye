...
Partial Class PRG_LI_GRP_POLY_PREM
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        strTableName = "TBIL_GRP_POLICY_PREM_INFO"
    ...
    Private Sub Proc_DoSave()
        ...
        Me.txtDOB_ANB.Text = Val(Trim(Me.txtDOB_ANB.Text))

        Me.txtPrem_Period_Yr.Text = Val(Trim(Me.txtPrem_Period_Yr.Text))
        ...
        myarrData = Split(Me.txtPrem_End_Date.Text, "/")
        If myarrData.Count <> 3 Then
            Me.lblMsg.Text = "Missing or Invalid " & Me.lblPrem_End_Date.Text & ". Expecting full date in ddmmyyyy format ..."
            FirstMsg = "Javascript:alert('" & Me.lblMsg.Text & "')"
            Exit Sub
        End If
        strMyDay = myarrData(0)
        ...
        If blnStatusX = False Then
            ...
            Exit Sub
        End If
        Me.txtPrem_End_Date.Text = RTrim(strMyDte)
        'mydteX = Mid(Me.txtStartDate.Text, 4, 2) & "/" & Left(Me.txtStartDate.Text, 2) & "/" & Right(Me.txtStartDate.Text, 4)
        mydteX = Trim(strMyMth) & "/" & Trim(strMyDay) & "/" & Trim(strMyYear)
        mydte = Format(CDate(mydteX), "MM/dd/yyyy")
        ...
        Call gnGET_SelectedItem(Me.cboPrem_SA_Currency, Me.txtPrem_SA_CurrencyCode, Me.txtPrem_SA_CurrencyName, Me.lblMsg)
        If Me.txtPrem_SA_CurrencyCode.Text = "" Then
            Me.lblMsg.Text = "Missing " & Me.lblPrem_SA_Currency.Text
            FirstMsg = "Javascript:alert('" & Me.lblMsg.Text & "')"
            Exit Sub
        End If
        ...
        Call MOD_GEN.gnInitialize_Numeric(Me.txtPrem_SA_Factor)
        If Val(Me.txtPrem_SA_Factor.Text) = 0 Then
            Me.lblMsg.Text = "Missing or Invalid " & Me.lblPrem_SA_Factor.Text
            FirstMsg = "Javascript:alert('" & Me.lblMsg.Text & "')"
            Exit Sub
        End If
        ...
        Call MOD_GEN.gnInitialize_Numeric(Me.txtPrem_Fixed_Rate)
        Call MOD_GEN.gnInitialize_Numeric(Me.txtPrem_Fixed_Rate_PerNum)
        ...
        Call MOD_GEN.gnInitialize_Numeric(Me.txtPrem_No_Instal)
...
SKIP_Next_88:
        ...
        Try
            ...
            If obj_DT.Rows.Count = 0 Then
                ...
                drNewRow("TBIL_POL_PRM_MDLE") = RTrim("G")
                ...
                drNewRow("TBIL_POL_PRM_SA_FACTOR") = Val(Trim(Me.txtPrem_SA_Factor.Text))
            ...
            Else
                ...
                With obj_DT
                    ...
                    .Rows(0)("TBIL_POL_PRM_MDLE") = RTrim("G")
                    ...
                    .Rows(0)("TBIL_POL_PRM_SA_FACTOR") = Val(Trim(Me.txtPrem_SA_Factor.Text))
...
Skip_C001:
    ...
    Private Function Proc_DoOpenRecord(ByVal FVstrGetType As String, ByVal FVstrRefNum As String, Optional ByVal FVstrRecNo As String = "", Optional ByVal strSearchByWhat As String = "FILE_NUM") As String
        ...
        If (objOLEDR.Read()) Then
            ...
            Me.txtPrem_SA_Factor.Text = RTrim(CType(objOLEDR("TBIL_POL_PRM_SA_FACTOR") & vbNullString, String))
    ...
    Protected Sub cmdPrev_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles cmdPrev.Click
        ...
        Dim pvURL As String = ""
        'pvURL = "prg_li_indv_poly_persnal.aspx?q=x"
        pvURL = "prg_li_grp_poly_persnal.aspx?q=x"
