...
Partial Class Policy_PRG_LI_GRP_POLY_ADD_COVER
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        strTableName = "TBIL_GRP_POLICY_ADD_PREM"
        ...
        If Not (Page.IsPostBack) Then
            ...
            Call DoProc_CreateDataSource("GL_PRODUCT_CAT_LIST", Trim("GRP"), Me.cboProductClass)
            ...
            If Trim(strF_ID) <> "" Then
                ...
                If oAL.Item(0) = "TRUE" Then
                    ...
                    Me.txtAdd_Period_Yr.Text = oAL.Item(19)
                    ...
                    If Trim(oAL.Item(20).ToString) <> "" Then
                        ...
                        Me.txtAdd_Start_Date.Text = Format(GenStart_Date, "dd/MM/yyyy")
                    End If
                    If Trim(oAL.Item(21).ToString) <> "" Then
                        ...
                        Me.txtAdd_End_Date.Text = Format(GenEnd_Date, "dd/MM/yyyy")
                    End If
            ...
            Call gnProc_Populate_Box("GL_RATE_TYPE_CODE_LIST", RTrim(Me.txtProduct_Num.Text), Me.cboAdd_Prem_Rate_Code)
    ...
    Protected Sub DoProc_Premium_Code_Change()
        ...
        Else
            ...
            'myRetValue = MOD_GEN.gnGET_RATE("GET_GL_PREMIUM_RATE", "GRP", Me.txtAdd_Prem_Rate_Code.Text, Me.txtProduct_Num.Text, Me.txtAdd_No_Prem_Yr.Text, Val(Me.txtDOB_ANB.Text), Me.lblMsg, Me.txtAdd_Prem_Rate_Per)
    ...
    Private Sub Proc_DataBind()
        ...
        strTable = strTableName
        strSQL = ""
        strSQL = strSQL & "SELECT ADD_COV.*"
        strSQL = strSQL & " ,COV.TBIL_COV_DESC"
        ...
        strSQL = strSQL & " AND COV.TBIL_COV_PRDCT_CD = ADD_COV.TBIL_POL_ADD_PRDCT_CD"
        strSQL = strSQL & " AND COV.TBIL_COV_MDLE_CD IN('GRP','G'))"
        strSQL = strSQL & " WHERE ADD_COV.TBIL_POL_ADD_FILE_NO = '" & RTrim(strF_ID) & "'"
        strSQL = strSQL & " AND ADD_COV.TBIL_POL_ADD_PROP_NO = '" & RTrim(strQ_ID) & "'"
        strSQL = strSQL & " ORDER BY ADD_COV.TBIL_POL_ADD_REC_ID"
                ...
                For Each subctrl In ctrl.Controls
                    If TypeOf subctrl Is System.Web.UI.WebControls.TextBox Then
                        If subctrl.ID = "txtFileNum" Or _
                           ...
                           subctrl.ID = "txtAdd_Period_Yr" Or _
                           subctrl.ID = "txtAdd_No_Prem_Yr" Or _
                           subctrl.ID = "txtAdd_Start_Date" Or _
                           subctrl.ID = "txtAdd_End_Date" Or _
    ...
    Private Sub Proc_DoSave()
        ...
        Call gnGET_SelectedItem(Me.cboAdd_Same_SA_Or_Diff, Me.txtAdd_Same_SA_Or_Diff, Me.txtAdd_Same_SA_Or_DiffName, Me.lblMsg)
        If Me.txtAdd_Same_SA_Or_Diff.Text = "" Then
            Me.lblMsg.Text = "Missing " & Me.lblAdd_Same_SA_Or_Diff.Text
            FirstMsg = "Javascript:alert('" & Me.lblMsg.Text & "')"
            Exit Sub
        End If
        ...
        If Trim(Me.txtAdd_Prem_Rate_TypeNum.Text) = "A" Or Trim(Me.txtAdd_Prem_Rate_TypeNum.Text) = "R" Then
            Me.txtAdd_Prem_Fixed_Rate_PerNum.Text = "1000"
        End If
        ...
        If Trim(Me.txtAdd_Prem_Rate_TypeNum.Text) = "R" And Val(Me.txtAdd_Prem_Rate_Per.Text) = 0 Then
            Me.txtAdd_Prem_Rate_Per.Text = "1000"
            'Me.lblMsg.Text = "Missing " & "Missing Premium Rate per e.g 100 or 1000 from rate table. Please select valid premium rate code..."
            'FirstMsg = "Javascript:alert('" & Me.lblMsg.Text & "')"
            'Exit Sub
        End If

        Call gnGET_SelectedItem(Me.cboAdd_SA_RT_AMT_CD, Me.txtAdd_SA_RT_AMT_CD, Me.txtAdd_SA_RT_AMT_CD_Name, Me.lblMsg)
        If Trim(Me.txtAdd_SA_RT_AMT_CD.Text) = "" Then
            'Me.lblMsg.Text = "Missing Sum Amount or Sum Assured Per Centage..."
            'FirstMsg = "Javascript:alert('" & Me.lblMsg.Text & "')"
            'Exit Sub
        End If

        Me.txtAdd_PCENT_SA.Text = Me.txtAdd_PCENT_SA.Text
        Call MOD_GEN.gnInitialize_Numeric(Me.txtAdd_PCENT_SA)
        If Trim(Me.txtAdd_SA_RT_AMT_CD.Text) = "R" And Val(Me.txtAdd_PCENT_SA.Text) = 0 Then
            Me.lblMsg.Text = "Missing Per Centage of Basic SA..."
            FirstMsg = "Javascript:alert('" & Me.lblMsg.Text & "')"
            Exit Sub
        Else
            Me.txtAdd_PCENT_SA.Text = "0"
        End If
        ...
        Try
            ...
            If obj_DT.Rows.Count = 0 Then
                ...
                drNewRow("TBIL_POL_ADD_PREM_SA_GRP_MEMB") = RTrim(Me.txtAdd_Same_SA_Or_Diff.Text)
            ...
            Else
                ...
                With obj_DT
                    ...
                    .Rows(0)("TBIL_POL_ADD_PREM_SA_GRP_MEMB") = RTrim(Me.txtAdd_Same_SA_Or_Diff.Text)
    ...
    Private Function Proc_DoOpenRecord(ByVal FVstrGetType As String, ByVal FVstrRefNum As String, Optional ByVal FVstrRecNo As String = "", Optional ByVal strSearchByWhat As String = "FILE_NUM") As String
        ...
        If (objOLEDR.Read()) Then
            ...
            Me.txtAdd_Same_SA_Or_Diff.Text = RTrim(CType(objOLEDR("TBIL_POL_ADD_PREM_SA_GRP_MEMB") & vbNullString, String))
            Call gnProc_DDL_Get(Me.cboAdd_Same_SA_Or_Diff, RTrim(Me.txtAdd_Same_SA_Or_Diff.Text))
            ...
            Select Case Trim(Me.txtAdd_Prem_Rate_TypeNum.Text)
                Case "R"
                    Me.cboAdd_Prem_Rate_Code.Enabled = True
                Case Else
                    Me.cboAdd_Prem_Rate_Code.Enabled = False
            ...
            Me.txtAdd_SA_RT_AMT_CD.Text = RTrim(CType(objOLEDR("TBIL_POL_ADD_SA_RT_AMT_CD") & vbNullString, String))
            Call gnProc_DDL_Get(Me.cboAdd_SA_RT_AMT_CD, RTrim(Me.txtAdd_SA_RT_AMT_CD.Text))
            Me.txtAdd_PCENT_SA.Text = RTrim(CType(objOLEDR("TBIL_POL_ADD_PCENT_SA") & vbNullString, String))
