<%@ Page Language="VB" AutoEventWireup="false" CodeFile="PRG_GP_PROP_POLICY.aspx.vb" Inherits="PRG_GP_PROP_POLICY" %>
...
<body style="background-color: White;">
    ...
    <div id="div_header" align="center">
        ...
        <div style="display: none;">
            &nbsp;<asp:Label ID="lblAction" ForeColor="LightGray" Text="Status:" runat="server"></asp:Label>&nbsp;<asp:textbox id="txtAction" ForeColor="LightGray" Text="" Visible="true" runat="server" EnableViewState="False" Width="30px"></asp:textbox></div>
    </div>
