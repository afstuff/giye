<%@ Page Language="VB" AutoEventWireup="false" CodeFile="PRG_LI_GRP_POLY_MEMBERS_ADD_1.aspx.vb" Inherits="Policy_PRG_LI_GRP_POLY_MEMBERS_ADD" %>
...
<body onload="<%= FirstMsg %>">
    ...
    <div id="div_content" align="center">
        <table class="tbl_cont" align="center">
                <tr>
                    <td nowrap class="myheader">Additional Members Information</td>
                </tr>
                <tr>
                        ...
                        <table align="center" border="0" class="tbl_menu_new">
                            ...
                            <tr>
                                                ...
                                                <td align="left" valign="top" colspan="1"><asp:TextBox ID="txtPolNum" Enabled="true" Width="250px" runat="server"></asp:TextBox>
                                                    &nbsp;<asp:Button ID="cmdGetPol" Enabled="false" Text="Go" runat="server" style="height: 26px" />
                                                </td>
                            </tr>
                            ...
                            <tr>
                                    ...
                                    <tr>
                                        <td align="left" colspan="4" valign="top" class="myMenu_Title">Additional Members Details</td>
                                    </tr>
                            ...
                            <tr>
                                <td nowrap  align="left" colspan="4" valign="top" style="width: 100%">
                                    <table align="center" border="1" style="width: 100%">
                                        <tr nowrap style="background-color: #ADD8E6;">
                                        ...
                                        <tr nowrap id="tr_file_upload" runat="server" style="background-color: #ADD8E6;">
                                                ...
                                                <td nowrap  align="left" valign="top" colspan="4">
                                                    ...
                                                    &nbsp;<asp:Label ID="lblFile_Upload_Warning" Visible="false" ForeColor="Red" runat="server" Text="Excel File of .XLS or .XLSX"></asp:Label>
                                                </td>                                        
                                        </tr>
                                        ...
                                        <tr class="tr_frame" style="display: none;">
                                            ...
                                            <td align="left" valign="top"><asp:Label ID="lblMedical_YN" Text="Req Medical" ToolTip="Any medical examination" runat="server"></asp:Label></td>
                                            <td align="left" valign="top"><asp:Label ID="lblPrem_Rate_X" Text="Select Premium Rate" ToolTip="" runat="server"></asp:Label>
                                            </td>
                                        </tr>
                                        <tr style="font-size: small; display: none;">
                                            ...
                                            <td align="left" valign="top">
                                                <asp:DropDownList ID="cboPrem_Rate_Code" Enabled="false" Width="200px" runat="server" AutoPostBack="true" OnTextChanged="DoProc_Premium_Code_Change">
                                                </asp:DropDownList>                                                
                                            </td>
                                        </tr>
                                ...
                                <tr style="font-size: small; display: none;">
                                    ...
                                    <td align="left" colspan="1">
                                        ...
                                        &nbsp;<asp:TextBox ID="txtPrem_Rate_TypeNum" Visible="true" Enabled="false" MaxLength="1" Width="20px" runat="server"></asp:TextBox>
                                    </td>
                                    <td align="left" colspan="1">
                                ...
                                <tr>
                                    <td align="left" colspan="2">
                                        ...
                                        &nbsp;&nbsp;<asp:TextBox ID="txtSum_Assured" Enabled="false" MaxLength="15" ToolTip="" runat="server"></asp:TextBox>                                            
                                            &nbsp;<asp:TextBox ID="txtPrem_Amt_Prorata" Visible="false" Enabled="false" MaxLength="15" Width="80px" runat="server"></asp:TextBox>
                                    ...
                                    <td align="right" colspan="2">
                                        ...
                                        &nbsp;<asp:DropDownList ID="cboErr_List" Visible="false" Width="350px" runat="server"></asp:DropDownList>
                                        &nbsp;
                                    </td>
                                </tr>
                                            ...
                                            <div class="div_grid">
                                                <asp:GridView id="GridView1" CellPadding="2" runat="server" CssClass="grd_ctrl"
                                                    ...
                                                    <Columns>
                                                        ...
                                                        <asp:BoundField readonly="true" DataField="TBIL_POL_MEMB_REC_ID" HeaderText="Ref.No" HeaderStyle-HorizontalAlign="Left" convertemptystringtonull="true" />
                                                        <asp:BoundField readonly="true" DataField="TBIL_POL_MEMB_NAME" HeaderText="Member Name" HeaderStyle-HorizontalAlign="Left" convertemptystringtonull="true" />
                                                        <asp:BoundField readonly="true" DataField="TBIL_POL_MEMB_TOT_EMOLUMENT" HeaderText="Emolument" HeaderStyle-HorizontalAlign="Left" convertemptystringtonull="true" />
                                                        <asp:BoundField readonly="true" DataField="TBIL_POL_MEMB_TOT_SA" HeaderText="Sum Assured" HeaderStyle-HorizontalAlign="Left" convertemptystringtonull="true" />
                                                        <asp:BoundField readonly="true" DataField="TBIL_POL_MEMB_AGE" HeaderText="Age" HeaderStyle-HorizontalAlign="Left" convertemptystringtonull="true" />
                                                        <asp:BoundField readonly="true" DataField="TBIL_POL_MEMB_RATE" HeaderText="Prem Rate" HeaderStyle-HorizontalAlign="Left" convertemptystringtonull="true" />
                                                        <asp:BoundField readonly="true" DataField="TBIL_POL_MEMB_PREM" HeaderText="Prem Amount" HeaderStyle-HorizontalAlign="Left" convertemptystringtonull="true" />
                                                        <asp:BoundField readonly="true" DataField="TBIL_POL_MEMB_BATCH_NO" HeaderText="Batch" HeaderStyle-HorizontalAlign="Left" convertemptystringtonull="true" />
                                                    </Columns>
