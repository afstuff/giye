...
Partial Class PRG_LI_GRP_POLY_MEMBERS
    ...
    Protected deleted_Prorata_Premium As Decimal
    Protected deleted_Prorata_Days As Integer
    ...
    Protected Sub Proc_DoDelItem()
        ...
        del_start_date = Format(mydte, "MM/dd/yyyy")
    ...
    Protected Sub Proc_DoDelete_Record(ByRef ErrorInd As String)
        ...
        strSQL = ""
        'Delete record i.e. move 'D' to the reocrd flag
        '==============================================
        strSQL = ""
        'strSQL = "DELETE FROM " & strTable
...
MyLoop_End:
    ...
    Private Function Proc_DoOpenRecord(ByVal FVstrGetType As String, ByVal FVstrRefNum As String, Optional ByVal FVstrRecNo As String = "", Optional ByVal strSearchByWhat As String = "FILE_NUM") As String
        ...
        If (objOLEDR.Read()) Then
            ...
            Me.txtPrem_Amt.Text = RTrim(CType(objOLEDR("TBIL_POL_MEMB_PREM") & vbNullString, String)) 'replaced the column name with TBIL_POL_MEMB_PRO_RATE_PREM
            ' Me.txtPrem_Amt.Text = RTrim(CType(objOLEDR("TBIL_POL_MEMB_PRO_RATE_PREM") & vbNullString, String))
    ...
    Protected Sub butDeleteMembers_ASP_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles butDeleteMembers_ASP.Click
        ...
        & "&gprem=" & deleted_Prorata_Premium & "&batchno=" & txtBatch_Num.Text & "&transdesc= Credit Note for Member(s)" & lblMsg.Text _
        & "&daysused=" & Math.Abs(deleted_Used_Days) & "&riskdays=" & txtRisk_Days.Text
        ...
        If chkCRNote.Checked = True Then
            Try
            ...
            Catch ex As Exception
                Me.lblMsg.Text = "<br />Unable to display the Credit Note Screen. <br />Reason: " & ex.Message.ToString
    ...
    Protected Sub chkCRNote_CheckedChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles chkCRNote.CheckedChanged
