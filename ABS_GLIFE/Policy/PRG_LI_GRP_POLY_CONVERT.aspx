<%@ Page Language="VB" AutoEventWireup="false" CodeFile="PRG_LI_GRP_POLY_CONVERT.aspx.vb" Inherits="Policy_PRG_LI_GRP_POLY_CONVERT" %>
	            ...
	            <table align="center" border="0" cellspacing="0" class="tbl_menu_new">
	                <tr>
                        <td align="right" colspan="2" valign="top">    
    	                        ...
    	                        &nbsp;<asp:DropDownList ID="cboSearch" AutoPostBack="true" Width="400px" runat="server"></asp:DropDownList>
                        </td>	                
	                </tr>
                            ...
                            <table width="100%">
                                <tr>
                                    ...
                                    <td align="right" colspan="1" valign="top">&nbsp;
                                        <a href="PRG_GP_PROP_POLICY.aspx?menu=GL_QUOTE" class="a_sub_menu">Return to Menu</a>&nbsp;                            
                                    </td>                           
                            ...
                            <asp:Label ID="lblMsg" Text="Status..." ForeColor="Red" runat="server"></asp:Label>
                                ...
                                <tr>
                                    ...
                                    <td align="left" colspan="1" valign="top">&nbsp;
                                        <asp:TextBox ID="txtProc_Date" Font-Bold="true" Width="120px" ToolTip="Please enter the date this transaction will enter your production" runat="server">
                                        </asp:TextBox>&nbsp;&nbsp;
                                        ...
                                        &nbsp;&nbsp;<asp:Label ID="lblProc_Rmks" ForeColor="Red" Text="Enter the date this transaction will enter your production" runat="server"></asp:Label>
                                    </td>
                                </tr>
            		...
            		<tr>
    		            ...
    		            <td nowrap align="left" colspan="1">&nbsp;
            		        <asp:textbox id="txtBatch_Num" Visible="true" MaxLength="10" Width="100px" runat="server" EnableViewState="true"></asp:textbox>
