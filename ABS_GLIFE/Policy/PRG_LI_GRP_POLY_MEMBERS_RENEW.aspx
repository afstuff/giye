<%@ Page Language="VB" AutoEventWireup="false" CodeFile="PRG_LI_GRP_POLY_MEMBERS_RENEW.aspx.vb"
    Inherits="Policy_PRG_LI_GRP_POLY_MEMBERS_RENEW" %>
                ...
                <td align="center" valign="top" class="td_menu">
                    <table align="center" border="0" class="tbl_menu_new">
                        ...
                        <tr>
                            ...
                            <td align="left" valign="top" colspan="1">
                                <asp:TextBox ID="txtPolNum" Enabled="true" Width="250px" runat="server"></asp:TextBox>
                        ...
                        <tr>
                            <td nowrap align="right" valign="top">
                                <asp:Label ID="lblPolicyStart" Enabled="False" Text="Start Date:" runat="server"></asp:Label>
                            </td>
                            <td align="left" valign="top" colspan="1">
                                <asp:TextBox ID="txtStartDate" runat="server"></asp:TextBox>
                            </td>
                            <td nowrap align="right" valign="top">
                                <asp:Label ID="lblPolicyEnd" Enabled="False" Text="End Date:" runat="server"></asp:Label>
                            </td>
                            <td align="left" valign="top" colspan="1">
                                ...
                                <table align="center" border="0" style="width: 100%">
                                    <tr style="background-color: #ADD8E6;">
                                        ...
                                        <td align="left" valign="top" colspan="4">
                                            ...
                                            <asp:Label ID="Label1" Text="Effective Date:" runat="server"></asp:Label><asp:TextBox
                                                ID="txtAdditionDate" runat="server"></asp:TextBox><script language="JavaScript" type="text/javascript">
                                            ...
                                            <div class="div_grid">
                                                <asp:GridView ID="GridView1" CellPadding="2" runat="server" CssClass="grd_ctrl" DataKeyNames="TBIL_POL_MEMB_REC_ID"
                                                    ...
                                                    <Columns>
                                                        ...
                                                        <asp:CommandField ShowSelectButton="True" ItemStyle-Width="60px" Visible="False">
