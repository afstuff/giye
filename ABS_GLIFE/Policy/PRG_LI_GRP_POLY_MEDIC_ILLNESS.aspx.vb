...
Partial Class Policy_PRG_LI_GRP_POLY_MEDIC_ILLNESS
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        strTableName = "TBIL_GRP_POLICY_ILLNESS"
    ...
    Private Sub Proc_DoSave()
        ...
        Try
            ...
            If obj_DT.Rows.Count = 0 Then
                ...
                drNewRow("TBIL_POL_ILL_BATCH_NO") = RTrim(Me.txtBatch_Num.Text)
                drNewRow("TBIL_POL_ILL_MEMB_NO") = Val(Me.txtMember_SN.Text)
            ...
            Else
                ...
                With obj_DT
                    ...
                    .Rows(0)("TBIL_POL_ILL_BATCH_NO") = RTrim(Me.txtBatch_Num.Text)
                    .Rows(0)("TBIL_POL_ILL_MEMB_NO") = Val(Me.txtMember_SN.Text)
    ...
    Private Function Proc_DoOpenRecord(ByVal FVstrGetType As String, ByVal FVstrRefNum As String, Optional ByVal FVstrRecNo As String = "", Optional ByVal strSearchByWhat As String = "FILE_NUM") As String
        ...
        strSQL = "SPGL_GET_POLICY_ILLNESS"
        ...
        If (objOLEDR.Read()) Then
            ...
            Me.txtBatch_Num.Text = RTrim(CType(objOLEDR("TBIL_POL_ILL_BATCH_NO") & vbNullString, String))
            Me.txtMember_SN.Text = RTrim(CType(objOLEDR("TBIL_POL_ILL_MEMB_NO") & vbNullString, String))
    ...
    Protected Sub cmdPrev_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles cmdPrev.Click
        ...
        Dim pvURL As String = ""
        pvURL = "prg_li_indv_poly_medic_info.aspx?q=x"
