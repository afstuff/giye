<%@ Page Language="VB" AutoEventWireup="false" CodeFile="PRG_LI_GRP_POLY_BENEFRY.aspx.vb" Inherits="Policy_PRG_LI_GRP_POLY_BENEFRY" %>
					...
					<td align="center" valign="top" class="td_menu">
						<table align="center" border="0" class="tbl_menu_new">
							...
							<tr>
								...
								<td align="right" valign="top" colspan="2">
									<asp:Label ID="lblMemberNo" Text="Member No:" runat="server"></asp:Label>
								</td>
								<td align="left" valign="top" colspan="1">
									<asp:TextBox ID="txtMemberNo" Enabled="false" runat="server" MaxLength="18"></asp:TextBox>
								</td>
							</tr>
							...
							<tr>
								<td align="left" colspan="5" valign="top" class="myMenu_Title">Beneficiary Details</td>
							</tr>
									...
									<table align="center" border="1" style="width: 100%">
										...
										<tr style="font-size: small;">
											<td align="left" valign="top">
												...
												&nbsp;<asp:TextBox ID="txtBenef_Age" Enabled="true" Width="40px" runat="server" 
										...
										<tr style="font-size: small;" class="tr_frame">
											<td align="left" valign="top">
												<asp:Label ID="lblBnkAcctNo" Text="Bank Account No" runat="server"></asp:Label></td>
											<td align="left" valign="top">
												<asp:Label ID="lblBnkName" Text="Bank Name and Address" runat="server"></asp:Label></td>
											<td align="left" valign="top">
												<asp:Label ID="lblBankSortCode" Text="Bank Sort Code" runat="server"></asp:Label></td>
											<td align="left" valign="top" colspan="2">
												<asp:Label ID="lblBenef_SN3" Text="S/No" runat="server"></asp:Label></td>
										</tr>
										<tr style="font-size: small;">
											<td align="left" valign="top">
												<asp:TextBox ID="txtBnkAcctNo" MaxLength="10" Width="100px" runat="server"></asp:TextBox>
												</td>
											<td align="left" valign="top">
												<asp:TextBox ID="txtBnkName_Address" Width="172px" 
                                                    runat="server" TextMode="MultiLine"></asp:TextBox>
												</td>
											<td align="left" valign="top">
												<asp:TextBox ID="txtBnkSortCode" Width="100px" runat="server"></asp:TextBox>
												</td>
											<td align="left" valign="top" colspan="2">
												<asp:TextBox ID="txtBenef_DOB3" MaxLength="10" Width="100px" 
                                                    ToolTip="Date of Birth(dd/mm/yyyy)" runat="server"></asp:TextBox>
												</td>
										</tr>
									</table>
								</td>
