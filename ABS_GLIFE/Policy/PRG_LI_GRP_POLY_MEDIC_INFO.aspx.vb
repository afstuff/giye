...
Partial Class Policy_PRG_LI_GRP_POLY_MEDIC_INFO
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        strTableName = "TBIL_GRP_POLICY_MEDIC_EXAM"
    ...
    Private Sub Proc_DoSave()
        ...
        If Me.txtMember_SN.Text = "" Or Val(Me.txtMember_SN.Text) = 0 Then
            Me.lblMsg.Text = "Missing or Invalid " & Me.lblMember_SN.Text
            FirstMsg = "Javascript:alert('" & Me.lblMsg.Text & "')"
            Exit Sub
        End If
        ...
        Try
            ...
            If obj_DT.Rows.Count = 0 Then
                ...
                drNewRow("TBIL_POL_MED_BATCH_NO") = RTrim(Me.txtBatch_Num.Text)
                drNewRow("TBIL_POL_MED_MEMB_NO") = Val(Me.txtMember_SN.Text)
            ...
            Else
                ...
                With obj_DT
                    ...
                    .Rows(0)("TBIL_POL_MED_BATCH_NO") = RTrim(Me.txtBatch_Num.Text)
                    .Rows(0)("TBIL_POL_MED_MEMB_NO") = Val(Me.txtMember_SN.Text)
    ...
    Private Function Proc_DoOpenRecord(ByVal FVstrGetType As String, ByVal FVstrRefNum As String, Optional ByVal FVstrRecNo As String = "", Optional ByVal strSearchByWhat As String = "FILE_NUM") As String
        ...
        strSQL = "SPGL_GET_POLICY_MED_EXAM"
        ...
        If (objOLEDR.Read()) Then
            ...
            Me.txtBatch_Num.Text = RTrim(CType(objOLEDR("TBIL_POL_MED_BATCH_NO") & vbNullString, String))
            Me.txtMember_SN.Text = RTrim(CType(objOLEDR("TBIL_POL_MED_MEMB_NO") & vbNullString, String))
    ...
    Protected Sub cmdPrev_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles cmdPrev.Click
        ...
        Dim pvURL As String = ""
        pvURL = "prg_li_indv_poly_add_cover.aspx?q=x"
    ...
    Protected Sub cmdNext_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles cmdNext.Click
        ...
        Dim pvURL As String = ""
        pvURL = "prg_li_indv_poly_medic_illness.aspx?q=x"
        pvURL = "prg_li_grp_poly_medic_illness.aspx?q=x"
        'pvURL = pvURL & "&optfileid=" & Trim(Me.txtFileNum.Text)
        'pvURL = pvURL & "&optpolid=" & Trim(Me.txtPolNum.Text)
        'pvURL = pvURL & "&optquotid=" & Trim(Me.txtQuote_Num.Text)
        Response.Redirect(pvURL)
