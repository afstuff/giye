                        ...
                        <table align="center" border="0" class="tbl_menu_new">
                            ...
                            <tr>
                                    ...
                                    <table align="center" border="0" style="width: 100%">
                                        ...
                                        <tr style="font-size: small; display: none;">
                                            ...
                                            <td align="left" valign="top" colspan="1">
                                                ...
                                                &nbsp;&nbsp;&nbsp;|&nbsp;&nbsp;<asp:TextBox ID="txtTotal_Emolument" MaxLength="15" ToolTip="" runat="server"></asp:TextBox></td>
                                            <td align="left" valign="top">
                                ...
                                <tr style="font-size: small; display: none;">
                                    ...
                                    <td align="left" colspan="1">
                                        ...
                                        &nbsp;<asp:TextBox ID="txtPrem_Rate_CodeName" Visible="false" Enabled="false" Width="30px" runat="server"></asp:TextBox>&nbsp;<asp:TextBox ID="txtPrem_Rate_TypeNum" Visible="true" Enabled="false" MaxLength="1" Width="20px" runat="server"></asp:TextBox></td>
                                    <td align="left" colspan="1">
                                        <asp:Label ID="lblPrem_Rate" Enabled="false" Text="Premium Rate:" runat="server"></asp:Label>
                                        &nbsp;<asp:TextBox ID="txtPrem_Rate" Enabled="false" Width="90px" ToolTip="" runat="server"></asp:TextBox></td>
                                    <td align="left" colspan="1">
                                        <asp:Label ID="lblPrem_Rate_Per" Enabled="false" Text="Rate Per:" runat="server"></asp:Label>
                                        &nbsp;<asp:TextBox ID="txtPrem_Rate_Per" Visible="true" Enabled="false" MaxLength="5" Width="60px" ToolTip="" runat="server"></asp:TextBox></td>
                                    <td align="left" colspan="1">
                                        <asp:Label ID="lblPrem_Amt" Enabled="false" Text="Prem Amount:" runat="server"></asp:Label>
                                        &nbsp;<asp:TextBox ID="txtPrem_Amt" Visible="true" Enabled="false" MaxLength="15" runat="server"></asp:TextBox></td>
                                </tr>
                            ...
                            <tr>
                                <td align="left" colspan="4" valign="top">
                                    ...
                                    <asp:Label ID="Label1" Text="Delete Eff. Date:" runat="server"></asp:Label><asp:TextBox ID="txtDeleteDate" runat="server"> </asp:TextBox>
