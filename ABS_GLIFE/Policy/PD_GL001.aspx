<%@ Page Language="VB" AutoEventWireup="false" CodeFile="PD_GL001.aspx.vb" Inherits="PD_GL001" %>
	            ...
	            <table align="center" border="0" cellspacing="0" class="tbl_menu_new">
	                <tr>
                        <td align="right" colspan="2" valign="top">    
    	                        ...
    	                        &nbsp;<asp:DropDownList ID="cboSearch" AutoPostBack="true" Width="300px" runat="server"></asp:DropDownList>
                        </td>	                
	                </tr>
                    ...
                    <tr>
                        ...
                        <td align="left" colspan="1" valign="top">&nbsp;                     
                            ...
                            &nbsp;<asp:TextBox ID="txtPrem_Rate_Code" Visible="false" Enabled="false" Width="20px" runat="server"></asp:TextBox>
                        </td>
                    </tr>
                    ...
                    <tr style="display: none;">
                        <td align="left" colspan="2" valign="top" style=" height: 500px; width: 100%;">
