<%@ Page Language="VB" AutoEventWireup="false" CodeFile="PRG_LI_GRP_POLY_PREM.aspx.vb" Inherits="PRG_LI_GRP_POLY_PREM" %>
                        ...
                        <table align="center" border="0" class="tbl_menu_new">
                            ...
                            <tr>
                                                ...
                                                <td align="left" valign="top" colspan="1">                                                    
                                                    ...
                                                    &nbsp;<asp:TextBox ID="txtCover_Num" Visible="true" Enabled="false" MaxLength="10" Width="80px" runat="server"></asp:TextBox>
                                                </td>
                            ...
                            <tr>
                                                ...
                                                <td align="left" colspan="1" valign="top"><asp:TextBox ID="txtPrem_Period_Yr" Text="1" runat="server"></asp:TextBox>
                                                </td>
                            ...
                            <tr>
                                                ...
                                                <td align="left" valign="top"><asp:TextBox ID="txtPrem_End_Date" MaxLength="10" Enabled="true" runat="server"></asp:TextBox>
                            ...
                            <tr>
                                ...
                                <td align="left" valign="top" colspan="1">
                                    ...
                                    &nbsp;<asp:TextBox ID="txtPrem_MOP_Type" Visible="false" Enabled="false" MaxLength="4" Width="40px" runat="server"></asp:TextBox>&nbsp;<asp:TextBox ID="txtPrem_MOP_TypeName" Visible="false" Enabled="false" MaxLength="4" Width="40px" runat="server"></asp:TextBox></td>
                                ...
                                <td align="left" valign="top"><asp:TextBox ID="txtPrem_MOP_Rate" Enabled="false" runat="server"></asp:TextBox>
                                    &nbsp;<asp:TextBox ID="txtPrem_MOP_Per" Visible="false" Enabled="false" MaxLength="5" Width="40px" runat="server"></asp:TextBox></td>
                            </tr>
                            ...
                            <tr>
                                <td nowrap align="left" valign="top"><asp:Label ID="lblPrem_SA_Factor" Text="Sum Assured Factor:" runat="server"></asp:Label></td>
                                <td align="left" valign="top" colspan="1">
                                    <asp:TextBox ID="txtPrem_SA_Factor" MaxLength="3" Width="40px" runat="server"></asp:TextBox>
                                </td>
                            </tr>

                            <tr>
                                <td nowrap align="left" valign="top"><asp:Label ID="lblPrem_SA_Currency" Text="Currency Type:" runat="server"></asp:Label></td>
                                <td align="left" valign="top" colspan="1">
                            ...
                            <tr>
                                ...
                                <td align="left" valign="top" colspan="1">
                                    <asp:DropDownList ID="cboPrem_Life_Cover" Width="80px" runat="server">
                                        <asp:ListItem Selected="False" Value="*">(Select)</asp:ListItem>
                                        <asp:ListItem Value="N">NO</asp:ListItem>
                                        <asp:ListItem Selected="True" Value="Y">YES</asp:ListItem>
                                    </asp:DropDownList>
                                    &nbsp;<asp:TextBox ID="txtPrem_Life_CoverNum" Text="Y" Visible="false" Enabled="false" MaxLength="1" Width="20px" runat="server"></asp:TextBox>
                                ...
                                <td align="left" valign="top"><asp:TextBox ID="txtPrem_Enrollee_Num"  MaxLength="4" Width="40px" runat="server"></asp:TextBox>
                                    &nbsp;<asp:Label ID="lblPrem_Enrollee_Num_Rmks" ForeColor="Red" Text="Applicable to Funeral Product" runat="server"></asp:Label></td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td align="left" valign="top" colspan="1">
                                    ...
                                    &nbsp;<asp:TextBox ID="txtPrem_Allocation_YN" Visible="false" Enabled="false" MaxLength="1" Width="20px"  runat="server"></asp:TextBox>&nbsp;<asp:TextBox ID="txtPrem_Allocation_YN_Name" Visible="false" Enabled="false" MaxLength="1" Width="20px"  runat="server"></asp:TextBox></td>
                                ...
                                <td align="left" valign="top" colspan="1">
                                    ...
                                    &nbsp;<asp:TextBox ID="txtPrem_Bonus_YN" Visible="true" Enabled="false" MaxLength="1" Width="20px"  runat="server"></asp:TextBox>&nbsp;<asp:TextBox ID="txtPrem_Bonus_YN_Name" Visible="false" Enabled="false" MaxLength="1" Width="20px"  runat="server"></asp:TextBox></td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td align="left" valign="top" colspan="1">
                                    ...
                                    &nbsp;<asp:TextBox ID="txtPrem_Rate_TypeNum" Visible="false" Enabled="false" MaxLength="1" Width="20px" runat="server"></asp:TextBox>&nbsp;<asp:TextBox ID="txtPrem_Rate_TypeName" Visible="false" Enabled="false" Width="20px" runat="server"></asp:TextBox></td>
                                <td align="left" valign="top" colspan="2"><asp:Label ID="lblPrem_Fixed_Rate" Enabled="false" Text="Fixed Rate:" runat="server"></asp:Label>
                                    &nbsp;&nbsp;<asp:TextBox ID="txtPrem_Fixed_Rate" Enabled="false" MaxLength="8" Width="60px"  runat="server"></asp:TextBox>&nbsp;&nbsp;<asp:Label ID="lblPrem_Fixed_Rate_Per" Enabled="false" Text="Fixed Rate Per:" runat="server"></asp:Label>&nbsp;
                                    ...
                                    &nbsp;<asp:TextBox ID="txtPrem_Fixed_Rate_PerName" Visible="false" Enabled="false" Width="20px" ToolTip="" runat="server"></asp:TextBox></td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td align="left" valign="top" colspan="3">
                                    ...
                                    &nbsp;</asp:TextBox>&nbsp;<asp:TextBox ID="txtPrem_Rate_CodeName" Visible="false" Enabled="false" Width="40px" runat="server"></asp:TextBox></td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                ...
                                <td align="left" valign="top" colspan="1">
                                    ...
                                    &nbsp;<asp:TextBox ID="txtPrem_Rate_Applied_On" Visible="false" Enabled="false" Width="20px" runat="server"></asp:TextBox></td>
                            ...
                            <tr style="display: none;">
                                ...
                                <td align="left" valign="top">
                                    ...
                                    &nbsp;<asp:TextBox ID="txtPrem_School_Term" Enabled="false" Visible="false" MaxLength="3" Width="20px" runat="server"></asp:TextBox>&nbsp;<asp:TextBox ID="txtPrem_School_Term_Name" Enabled="false" Visible="false" Width="20px" runat="server"></asp:TextBox></td>
