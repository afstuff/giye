...
Partial Class PRG_GP_PROP_POLICY
    ...
    Private Sub DoProc_Menu(ByVal pvMenu As String)
        Select Case pvMenu.ToUpper
            ...
            Case "GL_QUOTE"
                ...
                AddMenuItem("", "", "") 'blank link
                AddMenuItem("Additional", "Quote for Additional Members on Existing Policy", "PRG_LI_GRP_POLY_MEMBERS_ADD.aspx")
                'AddMenuItem("", "", "") 'blank link
        ...
        Try
            ...
            For intCX = 0 To Session.Count - 1
                ...
                If UCase(strSess) = UCase("connstr") Or _
                  ...
                  UCase(strSess) = UCase("StartdDate") Or _
                  UCase(strSess) = UCase("MyUserIDX") Or _
                  UCase(strSess) = UCase("MyUserID") Or _
                  UCase(strSess) = UCase("MyLogonTime") Or _
                  UCase(strSess) = UCase("MyUserName") Or _
                  UCase(strSess) = UCase("MyUserLevelX") Or _
                  UCase(strSess) = UCase("ABC_XYZ") Then
                Else
                    intC = intC + 1
