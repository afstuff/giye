<%@ Page Language="VB" AutoEventWireup="false" CodeFile="GRP_REINSURANCE.aspx.vb"
    Inherits="Reinsurance_GRP_REINSURANCE" %>
                    ...
                    <table align="center" border="0" cellpadding="1" cellspacing="1" class="tbl_menu_new">
                        ...
                        <tr>
                            ...
                            <td align="left" nowrap class="style2">
                                <asp:Label ID="lblTBGL_CODE" Enabled="False" Text="Re-Ins. Code:" 
                        ...
                        <tr style="">
                            <td align="right" nowrap class="style4">
                                <asp:Label ID="lblTBGL_DESC1" Enabled="False" Text="Reinsurance Module:" 
                                    runat="server"></asp:Label>
                            </td>
                            <td align="left" nowrap class="style3">
                            ...
                            <td align="left" nowrap class="style2">
                                <asp:Label ID="lblCompanyType" Enabled="False" Text="Company Type:" 
                                    runat="server"></asp:Label>
                            </td>
                            <td align="left" nowrap>
                        ...
                        <tr>
                            <td align="right" nowrap valign="top" class="style4">
                                <asp:Label ID="lblTBGL_DESC" Enabled="False" Text="Reinsurance Name:" 
                                    runat="server"></asp:Label>
                            </td>
                            <td align="left" nowrap class="style3">
                                <asp:TextBox ID="txtTBGL_DESC" runat="server" TextMode="MultiLine" 
                                    Width="250px"></asp:TextBox>
                            </td>
                            <td align="left" nowrap valign="top" class="style2">
                                <asp:Label ID="lblTBGL_DESC0" Enabled="False" Text="Reinsurance Short Name:"
                                    runat="server"></asp:Label>
                            </td>
                            <td align="left" nowrap valign="top">
                                <asp:TextBox ID="txtTBGL_SHRT_DESC" runat="server" TextMode="MultiLine" 
                                    Width="250px"></asp:TextBox>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td align="left" nowrap class="style3">
                                <asp:TextBox ID="txtTBGL_ADRES1" runat="server" TextMode="MultiLine" 
                                    Width="250px"></asp:TextBox>
                            </td>
                            <td align="left" nowrap valign="top" class="style2">
                            ...
                            <td align="left" nowrap>
                                <asp:TextBox ID="txtTBGL_ADRES2" runat="server" TextMode="MultiLine" 
                                    Width="250px"></asp:TextBox>
                            </td>
                        </tr>
                        <tr>
