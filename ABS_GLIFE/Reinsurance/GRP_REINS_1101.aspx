<%@ Page Language="VB" AutoEventWireup="false" CodeFile="GRP_REINS_1101.aspx.vb" Inherits="Reinsurance_GRP_REINS_1101" %>
                            ...
                            <table align="center" border="0">
                                ...
                                <tr>
    	                    	    <td nowrap align="right" colspan="1">&nbsp;
    	        	                    <asp:Label ID="lblRA_LIMIT" Text="ReAssurance Limit:" runat="server"></asp:Label>
    	                    	    </td>
    	                    	    <td nowrap align="left" colspan="2">&nbsp;
    	        	                    <asp:TextBox ID="txtRA_LIMIT" Font-Bold="true" ForeColor="Red" Width="200px" Text="7500000" runat="server"></asp:TextBox>
                   	        	    </td>
                                </tr>
