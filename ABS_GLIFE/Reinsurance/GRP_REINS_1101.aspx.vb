...
Partial Class Reinsurance_GRP_REINS_1101
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        PageLinks = "<a href='../MENU_GL.aspx?menu=GL_REINS' class='a_sub_menu'>Return to Menu</a>&nbsp;"
        ...
        Select Case UCase(Trim(myTType))
            Case "GRP_RPT_REINS_1101"
                STRMENU_TITLE = UCase("+++ ReAssurance Report +++ ")
                BufferStr = ""
            Case "GRP_RPT_REINS_1102"
                STRMENU_TITLE = UCase("+++ ReAssurance Register +++ ")
                BufferStr = ""
            Case Else
                STRMENU_TITLE = UCase("+++ ReAssurance Report +++ ")
                BufferStr = ""
    ...
    Protected Sub BUT_OK_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles BUT_OK.Click
        ...
        Dim myRA_LIMIT As String = "7500000"
        ...
        Select Case UCase(Trim(myTType))
            Case "GRP_RPT_REINS_1101"
                strRptTitle = "REASSURANCE REPORT"
                strRptTitle2 = "Report Title 2"
            Case "GRP_RPT_REINS_1102"
                strRptTitle = "REASSURANCE REGISTER"
                strRptTitle2 = "Report Title 2"
            Case Else
