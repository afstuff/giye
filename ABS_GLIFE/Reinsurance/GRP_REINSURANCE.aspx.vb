...
Partial Class Reinsurance_GRP_REINSURANCE
    ...
    Private Sub Proc_SearchPfa(ByVal sVal As String)
        ...
        strTable = "TBGL_REINSURANCE"
        strSQL = "SELECT *, RTRIM(ISNULL(TBGL_DESC,'')) AS TBGL_FULL_NAME FROM " & strTable & " where TBGL_DESC like '" & sVal.Trim & "%' or (TBGL_CODE like '" & sVal.Trim & "%') or (TBGL_SHRT_DESC like '" & sVal.Trim & "%') ORDER BY TBGL_DESC"
