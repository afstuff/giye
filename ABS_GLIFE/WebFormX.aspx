<%@ Page Language="VB" AutoEventWireup="false" CodeFile="WebFormX.aspx.vb" Inherits="WebFormX" %>
...
<head runat="server">
    ...
    <script language="javascript" type="text/javascript" src="Script/SJQ_02.js"></script>
                ...
                <td align="center" valign="top" colspan="4" style=" height:600px; width: 1000px;">
                    <table align="center" border="0">
                                            ...
                                            <div align="left" style="background-color: White; color: White; border-bottom-style: ridge; height: 35px;">
                                                <table align="left" border="0" style="background-color: #1C5E55; width: 100%; height: 30px;" >
                                                    <tr style="font-size: medium; font-weight: bold;">
                                                        ...
                                                        <td align="center" style="width: 80px;">Code</td>
                                                        <td align="center" style="width: 200px;">N A M E</td>
                                                    </tr>
                                                </table>
                                            </div>
                        ...
                        <tr>
                            <td align="left" colspan="4" valign="top">
                            <div class="div_grid">
                                <asp:GridView ID="GridView1" runat="server" AllowPaging="false"  CssClass="grd_ctrl"
                                    AutoGenerateColumns="False" CellPadding="4" ForeColor="#333333" GridLines="Both"
                                    DataKeyNames="MyFld_Rec_ID" HorizontalAlign="Left"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:BoundField DataField="MyFld_Rec_ID" HeaderText="Ref.No" ItemStyle-Width="70px" HeaderStyle-HorizontalAlign="Left" 
                                            ReadOnly="True">
                                        </asp:BoundField>
                                        <asp:BoundField DataField="MyFld_Value" HeaderText="Code" ItemStyle-Width="80px" HeaderStyle-HorizontalAlign="Left" 
                                            ReadOnly="True">
                                        </asp:BoundField>
                                        <asp:BoundField DataField="MyFld_Text" HeaderText="Code Name" ItemStyle-Width="200px" HeaderStyle-HorizontalAlign="Left"
                                            ReadOnly="true" >
                                        </asp:BoundField>
                                    </Columns>
