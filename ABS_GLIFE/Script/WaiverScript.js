...
function RetrieveAssuredCode() {
    ...
    $.ajax({
        type: "POST",
        url: "PRG_LI_GRP_CLM_WAIVER.aspx/GetPolicyPerInfo",
...
function retrieve_AdminCodeInfoValues(admobjects) {
    ...
    $.each(admobjects, function() {
        ...
        $('#HidAssuredName').
                val($(this).find("TBIL_INSRD_SURNAME").text() + '  ' + $(this).find("TBIL_INSRD_FIRSTNAME").text())
        $('#txtPolicyProCode').val($(this).find("TBIL_POLY_PRDCT_CD").text())
        $('#HidPolicyProCode').val($(this).find("TBIL_POLY_PRDCT_CD").text())
...
function GetCoverCodes() {
    $.ajax({
        type: "POST",
        url: "PRG_LI_GRP_CLM_WAIVER.aspx/GetCoverCodes",
        contentType: "application/json; charset=utf-8",
        dataType: "json",
...
function VerifyAdditionalPolicyCover() {
    ...
    $.ajax({
        type: "POST",
        url: "PRG_LI_GRP_CLM_WAIVER.aspx/VerifyAdditionalCover",
...
function Get_Effected_Waiver_Dsc(waiverCode) {
    $.ajax({
        type: "POST",
        url: "PRG_LI_GRP_CLM_WAIVER.aspx/GetEffectedWaiverDsc",
